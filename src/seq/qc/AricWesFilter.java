...
public class AricWesFilter {
	...
	public VariantFilterSample getARICVariantContextFilters() {
		...
		builder.vCFiltWholeVariant(new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] { callrate, hwe }, new VARIANT_FILTER_BOOLEAN[] { biallelic }, null, null, log));
		...
		builder.vCFiltAltGeno(new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] { altDP, altRatLow, altRatHigh }, new VARIANT_FILTER_BOOLEAN[] {}, null, null, log));
		...
		builder.vCFiltAllGeno(new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] {gq, totalDepth }, new VARIANT_FILTER_BOOLEAN[] {}, null, null, log));
		...
		builder.vCFiltIndel(new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] { indelDepth }, new VARIANT_FILTER_BOOLEAN[] {}, null, null, log));
