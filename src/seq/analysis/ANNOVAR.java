...
public class ANNOVAR {
	...
	private static final String DEFAULT_OPERATIONS = "g,r,r,f,f,f,f";
	...
	public AnnovarResults AnnovarAVCF(String inputVCF, String build, Logger log) {
		AnnovarResults annovarResults = new AnnovarResults(inputVCF, build);
		annovarResults.parse();
		boolean progress = AnnovarAVCF(annovarResults.getInputVCF(), annovarResults.getOutput(), annovarResults.getOutputVCF(), annovarResults.getBuild(), log);
