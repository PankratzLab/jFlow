...
public class PlinkSeq implements Serializable {
	...
	private boolean loadVarSet(PseqProject pseqProject, String varSetFile) {
		boolean progress = false;
		String[] command = new String[] { PSEQ, pseqProject.getProjectNameForPseq(), VAR_SET, FILE, varSetFile };
		progress = CmdLine.runCommandWithFileChecks(command, "", new String[] { varSetFile }, null, true, false, false, log);
		return progress;
	}
	...
	public static PseqProject initialize(PlinkSeq pSeq, String projName, String directory, String vcf, VcfPopulation vpop, String resourceDirectory, boolean loadVCF, boolean loadReq, Logger log) {
		...
		return initialize(pSeq, projectName, projectDirectory, new String[] { vcf }, vpop == null ? null : phenoFile, resourceDirectory, loadVCF, loadReq, log);
	}
	...
	public static PseqProject initialize(PlinkSeq pSeq, String projectName, String projectDirectory, String[] vcfs, String phenoFile, String resourceDirectory, boolean loadVCF, boolean loadReq, Logger log) {
		new File(projectDirectory).mkdirs();
