...
//        long time;
    	        	...
    	        	try {
    		            ...
    		            while (reader.ready()) {
    		            	...
    		            	if (hash.containsKey(line[0]+"_"+line[1])) {
    		            		writer.println(inds[i]+"\t"+hash.get(line[0]+"_"+line[1])+"\t"+Array.toStr(line));
    		            		writer.flush();
    		            ...
    		            System.err.println("Error: file \""+dir+files[fileIndex]+"\" not found in current directory");
    		            System.exit(1);
	...
	public static void filter(String filesToFilter) {
		...
		hash = HashVec.loadFileToHashString(varFile, new int[] {0,1}, null, false, "\t", false, false, false);
		try {
	...
	public static void main(String[] args) {
	    ...
	    "   (2) directory of coverage files (i.e. cov="+dir+" (default))\n"+
	    " OR\n"+
