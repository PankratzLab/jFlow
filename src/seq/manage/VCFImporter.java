...
public class VCFImporter {
	...
	public static void test(Project proj, String vcf, String gc5Base, PREPPED_SAMPLE_TYPE type, int numRounds, int numThreads) {
		...
		MitoPipeline.catAndCaboodle(projNorm, numThreads, pretendMedian, 100, projNorm.PROJECT_DIRECTORY.getValue() + "VCF_PCS", true, true, 0.98, useFile, null, null, true, true, true, false, true, false, null, -1, -1, GENOME_BUILD.HG19, false);
