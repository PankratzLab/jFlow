		...
		for (int j = 0; j < RACES.length; j++) {
			...
			for (int i = 0; i < STUDIES.length; i++) {
				...
				if (new File(dir+"abo_icam.dosage").exists()) {
					...
					Files.writeList(new String[] {"hits", "abo_icam.ids.fam 1 hideIndex out=demographics.dat", "abo_icam.ids.fam 1 0=FID 1=IID skip=0", "pheno/db.txt 1 3;. 5;. 6;. 7;. !9=0 fail"}, dir+"generateDemographics.crf");
