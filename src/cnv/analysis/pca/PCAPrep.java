...
public class PCAPrep {
	...
	public static int prepPCA(Project proj, int numThreads, String outputBase, boolean markerQC, double markerCallRateFilter, String useFile, SampleList sampleList, Logger log) {
		int[] counts;
