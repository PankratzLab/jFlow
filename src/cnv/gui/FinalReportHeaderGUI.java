...
public class FinalReportHeaderGUI extends JDialog {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FinalReportHeaderGUI frame = new FinalReportHeaderGUI(new FinalReportHeaderData());
     ...
     * @param reportHdr 
     */
    public FinalReportHeaderGUI(FinalReportHeaderData reportHdr) {
        ...
        String[] headerParts = reportHdr.getHeaderString().split("[\\s]*,[\\s]*");
        ...
        cbSnpInd.setSelectedIndex(reportHdr.col_snpIndex == -1 ? 0 : reportHdr.col_snpIndex); // TODO SNP INDEX shouldn't ever be -1
        ...
        cbSampInd.setSelectedIndex(reportHdr.col_sampleID == -1 ? 0 : 1 + reportHdr.col_sampleID);
        panel.add(cbSampInd, "cell 2 3,growx");
        
        JLabel lblRecommended = new JLabel("Recommended:");
        lblRecommended.setFont(new Font("Tahoma", Font.BOLD, 11));
        ...
        cbA1Geno.setSelectedIndex(reportHdr.col_geno_1 == -1 ? 0 : 1 + reportHdr.col_geno_1);
        ...
        cbA2Geno.setSelectedIndex(reportHdr.col_geno_2 == -1 ? 0 : 1 + reportHdr.col_geno_2);
        ...
        cbA1AB.setSelectedIndex(reportHdr.col_genoAB_1 == -1 ? 0 : 1 + reportHdr.col_genoAB_1);
        ...
        cbA2AB.setSelectedIndex(reportHdr.col_genoAB_2 == -1 ? 0 : 1 + reportHdr.col_genoAB_2);
        ...
        cbX.setSelectedIndex(reportHdr.col_x == -1 ? 0 : 1 + reportHdr.col_x);
        ...
        cbY.setSelectedIndex(reportHdr.col_y == -1 ? 0 : 1 + reportHdr.col_y);
        ...
        cbBAF.setSelectedIndex(reportHdr.col_BAF == -1 ? 0 : 1 + reportHdr.col_BAF);
        ...
        cbLRR.setSelectedIndex(reportHdr.col_LRR == -1 ? 0 : 1 + reportHdr.col_LRR);
        ...
        cbGC.setSelectedIndex(reportHdr.col_gc == -1 ? 0 : 1 + reportHdr.col_gc);
        panel.add(cbGC, "cell 2 13,growx");
        
        JLabel lblOptional = new JLabel("Optional:");
        lblOptional.setFont(new Font("Tahoma", Font.BOLD, 11));
        ...
        cbXRaw.setSelectedIndex(reportHdr.col_xRaw == -1 ? 0 : 1 + reportHdr.col_xRaw);
        ...
        cbYRaw.setSelectedIndex(reportHdr.col_yRaw == -1 ? 0 : 1 + reportHdr.col_yRaw);
        ...
        cbR.setSelectedIndex(reportHdr.col_r == -1 ? 0 : 1 + reportHdr.col_r);
        ...
        cbTheta.setSelectedIndex(reportHdr.col_theta == -1 ? 0 : 1 + reportHdr.col_theta);
...
//        return MISSING_STR.equals(cb.getSelectedItem()) ? MISSING_IND : cb.getSelectedIndex() - 1;
    ...
    public int getGeno1() { return getValue(cbA1Geno); }
    public int getGeno2() { return getValue(cbA2Geno); }
    public int getAB1() { return getValue(cbA1AB); }
    public int getAB2() { return getValue(cbA2AB); }
    public int getBAF() { return getValue(cbBAF); }
    public int getLRR() { return getValue(cbLRR); }
    public int getGC() { return getValue(cbGC); }
    public int getR() { return getValue(cbR); }
    public int getTheta() { return getValue(cbTheta); }
    public int getX() { return getValue(cbX); }
    public int getY() { return getValue(cbY); }
    public int getXRaw() { return getValue(cbXRaw); }
    public int getYRaw() { return getValue(cbYRaw); }
}
