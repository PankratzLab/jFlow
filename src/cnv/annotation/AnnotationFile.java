 ...
 * @author lane0212
 *
 *         This filetype may be useful when storing/accessing annotations that typically represent an entire project and are not updated frequently...i.e a more static version of {@link AnnotationCollection} <br>
...
public abstract class AnnotationFile {
	 ...
	 * @param proj
	 * @param types
	 *            used for extracting data types
	 * @param keys
	 *            used for building/verifying the vcf header hash
