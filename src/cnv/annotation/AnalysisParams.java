...
/**
 * @author lane0212 Used to read and write custom genvisis analysis parameters (like blast results) in {@link AnnotationFileWriter } and {@link AnnotationFileLoader}
 */
public interface AnalysisParams {
	...
	/**
	 * @param vcfHeaderLine
	 *            parse this header, ensure proper key match
	 */
