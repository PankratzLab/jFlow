...
public class GenericMultiAnnotation implements AnnotationParser {
	 ...
	 */
	public static final String[] SNP_EFF_BASIC = new String[] { "SNPEFF_GENE_NAME", "SNPEFF_IMPACT", "SNPEFF_TRANSCRIPT_ID" };
	public static final String[] FREQ_BASIC = new String[] { "popfreq_max_20150413", "popfreq_all_20150413", "esp6500siv2_all", "esp6500siv2_aa", "esp6500siv2_ea" };

	private Hashtable<String, Integer> index;
	private String[] locusNames;
	private String[] keysToLoad;
	private String[][] data;
	private boolean found;// Warning, is true if any of the locusNames are found

	/**
	 * @param locusNames
	 *            will typically be the marker names of interest
	 * @param keysToLoad
	 *            annotation keys to populate
	 */
