...
public class MosaicPlot extends JFrame implements ActionListener {
	...
	public static final String[] MOSAICISM_HEADER = { "Sample", "Band", "LRR N", "mean LRR", "BAF N", "SD of BAF (0.15-0.85)", "IQR of BAF (0.15-0.85)", "%Homo", "BandPercentMosaicism", "MosaicMetric", "MosaicNearestNeighbor" };
