    ...
    public void mouseMoved(MouseEvent e) {
        ...
        for (CNVRectangle cnvRect : rectangles) {
            ...
            if (rect.contains(e.getPoint())) {
                ...
                String toolTipText = "<html>IID: " + cnv.getIndividualID() + "<br/>FID: " + cnv.getFamilyID()
                        + "<br/>Length: " + cnv.getSize() + "<br/>Copies: " + cnv.getCN() + "<br/>Probes: "
                        + cnv.getNumMarkers() + "<br/>Score: " + cnv.getScore();
