...
public class CNVRectangle extends GenericRectangle implements Comparable<CNVRectangle> {
	 ...
	 * 
	 * @param variants
	 *            A list of CNVs to be associated with this rectangle
	 */
	...
	/**
	 * @param color
	 *            The Color in which the rectangle should be rendered
	 */
	 ...
	 * 
	 * @param filename
	 *            The name of the file from which this CNV originated
	 */
	...
	/**
	 * Defines a rectangle for this CNV. X and Y are not direct coordinates, they are base positions. They get translated to relative coordinates in CompPanel.
	 * 
	 * @param x
	 *            Start X coordinate for this rectangle
	 * @param y
	 *            Start Y coordinate for this rectangle
	 * @param width
	...
	/**
	 * Indicates whether this rectangle is selected. Selected rectangles have a black border drawn around them
	 * 
	 * @param sel
	 *            True to select it, false otherwise
	 */
