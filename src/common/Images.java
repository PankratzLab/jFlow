...
//		} else {
			...
			finalImage = new BufferedImage((maxWid * arrSzCols) + bufferCols, (maxHgt * arrSzRows) + bufferRows, BufferedImage.TYPE_INT_ARGB);
			if (bgColor != null) {
...
//	
//	private static BufferedImage packedImage(final String[] imageFiles, final HashMap<String, BufferedImage> images, Color bgColor, boolean[] drawBorder) {
...
//		
//		BufferedImage finalImage = new BufferedImage((maxWdt * cols) + bufferX, (maxHgt * rows) + bufferY, BufferedImage.TYPE_INT_ARGB);
//		
//		
//		if (bgColor != null) {
//			finalImage.createGraphics().setColor(bgColor);
