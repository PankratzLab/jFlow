...
public class Aliases {
	public static final String[] MARKER_NAMES = {"MarkerName", "Marker", "Name", "SNP", "SNPID", "SNP.id", "rs_id", "Variant", "AnalysisUnit", "Variant_ID", "SingleVariant", "BurdenTests", "RSID","BinName" };
