...
public class TestLogicle
{
  ...
  /**
   * Test method for {@link edu.edu.stanford.facs.logicle.FastLogicle#intScale(double)}.
   * Test that the scale function really is the inverse of the biexponential
   */
  @Test
  ...
  /**
   * Test method for {@link edu.edu.stanford.facs.logicle.FastLogicle#scale(double)}.
   * Test that the scale function really is the inverse of the biexponential
   */
  @Test
