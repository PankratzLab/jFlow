...
public class LogisticRegression extends RegressionModel {
  ...
  public LogisticRegression(List vDeps, List vIndeps, boolean bypassDataChecks, boolean verbose) {
  ...
  // }
  // if (iv.size()==1) {
  // System.err.println("Error in logistic regression - Dependent variables must be 2 consecutive
  // integers, not just '"+iv.elementAt(0)+"')");
  // return false;
  // } else if (iv.size()>2||Math.abs(iv.elementAt(0)-iv.elementAt(1))!=1) {
  // System.err.println("Error in logistic regression - Dependent variables must be 2 and no more
  // than 2 consecutive integers");
  // return false;
  // }
  //
