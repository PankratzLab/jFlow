...
public class FishersExact2by2Calculator {
  ...
  private static double computePval(int a, int b, int c, int d) {
    return Math.exp((CACHED_LOG_FACTORIAL.get(a + b) + CACHED_LOG_FACTORIAL.get(c + d)
                     + CACHED_LOG_FACTORIAL.get(a + c) + CACHED_LOG_FACTORIAL.get(b + d))
                    - (CACHED_LOG_FACTORIAL.get(a + b + c + d) + CACHED_LOG_FACTORIAL.get(a)
                       + CACHED_LOG_FACTORIAL.get(b) + CACHED_LOG_FACTORIAL.get(c)
  ...
  public static void main(String[] args) {
    double chiP, fishP;
    int[][][] testMatrices = new int[][][] {{{0, 20}, {0, 25}}, {{2, 20}, {3, 25}},
                                            {{0, 20}, {5, 20}}, {{0, 2100}, {0, 2500}},
                                            {{0, 2100}, {5, 2500}}, {{0, 2100}, {10, 2500}},
                                            {{210, 2100}, {250, 2500}},};
