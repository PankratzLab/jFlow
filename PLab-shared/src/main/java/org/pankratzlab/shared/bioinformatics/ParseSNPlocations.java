...
public class ParseSNPlocations {
  ...
  // lowMemParse(snpListFile, ParseSNPlocations.DEFAULT_B37_DB, ParseSNPlocations.DEFAULT_MERGE,
        ...
        if (!parts[0].startsWith("rs")) {
          ...
          if (markerVC == null) {
            ...
            if (unmappedVCFReader != null) {
              ...
              vcIterUn = null;
              if (markerVC == null) {
                // System.err.println("Error - couldn't find {" + parts[0] + "} in the unmapped
                // database. Checking merged database now...");
              }
            }
  ...
  public static void main(String[] args) throws IOException {
    ...
    // db = "D:/RSMerge.ser";
    // vcf=N:/statgen/NCBI/All_20150605_rsDominant.vcf.gz
    // unmappedvcf=N:/statgen/NCBI/All_20150605_papu_rsDominant.vcf.gz
    // mergedvcf=N:/statgen/NCBI/RsMerge.vcf.gz
    ...
    for (String arg : args) {
      if (arg.equals("-h") || arg.equals("-help") || arg.equals("/h") || arg.equals("/help")) {
        ...
        vcf = arg.split("=")[1];
        numArgs--;
      } else if (arg.startsWith("mergedvcf=")) {
        mergedvcf = arg.split("=")[1];
        numArgs--;
      } else if (arg.startsWith("unmappedvcf=")) {
        unmappedvcf = arg.split("=")[1];
        numArgs--;
