...
public class DumpSAS {
  ...
  public static final String[] CONTENTS_HEADER = {"LIBNAME", "MEMNAME", "MEMLABEL", "TYPEMEM",
                                                  "NAME", "TYPE", "LENGTH", "VARNUM", "LABEL",
                                                  "FORMAT", "FORMATL", "FORMATD", "INFORMAT",
                                                  "INFORML", "INFORMD", "JUST", "NPOS", "NOBS",
                                                  "ENGINE", "CRDATE", "MODATE", "DELOBS",
                                                  "IDXUSAGE", "MEMTYPE", "IDXCOUNT", "PROTECT",
                                                  "FLAGS", "COMPRESS", "REUSE", "SORTED",
                                                  "SORTEDBY", "CHARSET", "COLLATE", "NODUPKEY",
                                                  "NODUPREC", "ENCRYPT", "POINTOBS", "GENMAX",
                                                  "GENNUM", "GENNEXT"};
