...
public final class CFCSParameters extends CFCSAbstractParameters {
  ...
  private final Map<Object, CFCSAbstractParameter> cache =
      new HashMap<Object, CFCSAbstractParameter>();
  ...
  private final static String[][] DATA_PROPERTIES =
      {{"S", "FullName", "N"}, {"N", "ShortName", "N"}, {"B", "FieldSizeString", "Y"},
       {"R", "Range", "Y"}, {"G", "Gain", "N"}, {"F", "Filter", "N"},
       {"L", "ExcitationWavelength", "N"}, {"O", "LaserPower", "N"}, {"P", "EmittedPercent", "N"},
       {"V", "Voltage", "N"}, {"T", "DetectorType", "N"}, {"E", "LogDecadesAndOffset", "Y"},
       {"D", "PreferredDisplay", "N"}, {"Calibration", "Calibration", "N"},};
