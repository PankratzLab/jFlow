...
public abstract class CFCSAbstractParameters implements CFCSErrorCodes {
  ...
  protected final Map<String, PropertyDescriptor> parameter_descriptors =
      new HashMap<String, PropertyDescriptor>();

  // --------------------------------------------------------------------

  protected static final String[] keyword_properties =
      {"KeywordValue", "KeywordIntegerValue", "KeywordDoubleValue",};

  protected static final Map<Class<?>, PropertyDescriptor> keyword_descriptors =
  ...
  protected final void getParameter(int index, final CFCSAbstractParameter parameter) {
    ...
    for (int i = 0; i < parameter_properties.length; i++) {
      ...
      CFCSKeyword keyword =
          keywords.getSystemKeyword(getPrefix() + index + parameter_property[PARAMETER_CODE]);
      ...
      PropertyDescriptor keyword_desc =
          (PropertyDescriptor) keyword_descriptors.get(parameter_desc.getPropertyType());
