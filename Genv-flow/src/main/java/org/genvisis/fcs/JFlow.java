...
import org.genvisis.fcs.gating.GateFileWriter;
import org.genvisis.fcs.gating.GateTreePanel;
import org.genvisis.fcs.gating.Gating;
import org.genvisis.fcs.gating.Workbench;
import org.genvisis.fcs.sub.DataExportGUI;
import org.genvisis.fcs.sub.EMModel;
...
public class JFlow extends JPanel implements WindowListener, PropertyChangeListener {
  ...
  private void resetForNewData(final FCSDataLoader newDataLoader) {
    ...
    final List<String> colNames = newDataLoader.getAllDisplayableNames(DATA_SET.ALL);
    final List<String> colNamesY = newDataLoader.getAllDisplayableNames(DATA_SET.ALL);
  ...
  private void dumpData() {
    ...
    List<String> params = dataLoader.getAllDisplayableNames(DATA_SET.COMPENSATED);
