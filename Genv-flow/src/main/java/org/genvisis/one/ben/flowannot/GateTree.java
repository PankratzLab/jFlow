...
public final class GateTree {
	...
	static final String[][] GATE_TREE_PANEL_1 = { // mapping[i][0] = child, mapping[i][1] = parent,
			...
			{"effector helper Tcells (CD95/CD28)", "effector helper Tcells (CCR7- CD45RA+)"},
			{"naive helper Tcells (CCR7+ CD45RA+)", "Helper Tcells-CD4+"},
			{"naive helper Tcells (CD95/CD28)", "naive helper Tcells (CCR7+ CD45RA+)"},
			{"CD45RA-", "Helper Tcells-CD4+"},
			{"CCR7gate", "CD45RA-"},
			{"effector memory helper Tcells (CCR7- CD45RA-)", "Helper Tcells-CD4+"},
			{"effector memory helper Tcells (CD95/CD28)", "effector memory helper Tcells (CCR7- CD45RA-)"},
			{"central memory helper Tcells (CCR7+ CD45RA-)", "Helper Tcells-CD4+"},
			{"central memory helper Tcells (CD95/CD28)", "central memory helper Tcells (CCR7+ CD45RA-)"},
			...
			{"effector cytotoxic Tcells (CD95/CD28)", "effector cytotoxic Tcells  (CCR7-  CD45RA+)"},
			...
			{"naive cytotoxic Tcells (CD95/CD28)", "naive cytotoxic Tcells (CCR7+ , CD45RA+)"},
			{"CD45RA-", "cytotoxic Tcells-CD8+"},
			{"CCR7gate", "CD45RA-"},
