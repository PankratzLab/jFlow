...
public class temp {
  ...
  public static void runPennCnv(String infile) {
    ...
    // -pfb ../custom.pfb -gcmodel ../custom.gcmodel [%1] [%2] [%0] -out
    // ../joint_results/[%0].jointcnv 2> ../joint_results/[%0].log";
  ...
  public static void parseAllFilesInDorectory(String dir) {
    ...
    // Files.combine(keys, fileParameters, headers, unit, outputFilename, log, ignoreCase,
    // finalHeader, hideIndex, outIsCommaDelimited)
    // Files.combine(uniqueValues, fileParameters, null, "MarkerName", outputFilename, log, true,
    // true, true, false)

    // String[] fileParameters = new String[] {"model1.out 'MarkerName' 'Chr' 'Position'
    // 'Effect_allele' 'Reference_allele' 'N' 'Effect_allele_frequency' 'BETA'=beta_M1
    // 'P-value'=pval_M1",
  ...
  public static void parseIt(String filename, String locationOfGenotypeFiles) {
    ...
    // parse results
    // ResultsPackager.parseStdFormatFromPlink(dir, "D:/scratch/model1.assoc.linear", "ADD",
    // "../filteredGenotypes/plink.bim", "D:/scratch/model1_freq.frq", null, outfile, log);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // Internat.downloadFile("http://www.ncbi.nlm.nih.gov/pmc/articles/PMC2708794/pdf/JPATH175000054.pdf",
      // "D:/SH3GL2.pdf");
      ...
      // schaid("D:/tWork/LOAD/Schaid_request/pruned_snps/load_fancy_eigens.xln",
      // "D:/tWork/LOAD/Schaid_request/pruned_snps/all_load_fancy_eigens.out");
      // schaid("D:/tWork/LOAD/Schaid_request/pruned_snps/load_fancy_postnormed_eigens.xln",
      // "D:/tWork/LOAD/Schaid_request/pruned_snps/all_load_normalized_fancy_eigens.out");
