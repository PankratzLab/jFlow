...
public class parametric {
	...
	public parametric(int chromosome, boolean dominant, double freq, double penetrance, double phenocopy) throws IOException {
		...
		try {
			...
			try {
				reader = new BufferedReader(new FileReader("/home/npankrat/park/00masters/map"+chrome+".dat"));
				...
				System.err.println("Could not find map"+chrome+".dat in /home/npankrat/park/00masters/ or in the current directory");
				System.exit(1);
			}
		...
		writer.println(ext.formDeci(1-freq, 8, true)+" "+ext.formDeci(freq, 8, true)+"  << GENE FREQUENCIES");
		writer.println("1  << NO. OF LIABILITY CLASSES");
		writer.println(ext.formDeci(phenocopy, 4, true)+" "+ext.formDeci((dominant?penetrance:phenocopy), 4, true)+" "+ext.formDeci(penetrance, 4, true));
