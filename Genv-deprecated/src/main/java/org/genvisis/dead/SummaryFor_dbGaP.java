...
public class SummaryFor_dbGaP {
  ...
  public static final String[] FINAL_HEADER =
      {"Chip_batch_name", "SNP_ID  # original ID or ss#  used by the chip vender. ",
       "Original Allele 1  (probe allele)", "Original Allele 2  (probe allele)",
       "Genotype 1-1 Case", "Genotype 1-2 Case", "Genotype 2-2 Case", "Genotype 1-1 Control",
       "Genotype 1-2 Control", "Genotype 2-2 Control", "HWE Cases", "HWE Controls",
       "Odds ratio (for allele 1)", "Test Statistic", "P value"};
