...
public class compGroups {
  ...
  public static String[] USE =
      {"BirthDate", "AgeAtOnset", "AgeAtExam", "Duration", "AOO", "DurationFromAOO", "EarlyOnset45",
       "EarlyOnset50", "EarlyOnset60", "EarlyDisease", "LateDisease", "MidDisease", "Affected",
       "VPD", "CONF_PD", "Male", "Caucasian", "Hispanic", "AffFather", "AffMother", "AffParent",
       "parkin", "polymorph", "G2019S", "Depression", "Depressed", "DSMIV_Dx_Depression",
       "MajorDepression", "MinorDepression", "MMSE", "Demented", "BlessedFunctionality",
       "Education", "MilitaryYears", "smoked", "smoker", "alcohol", "pesticides", "OnsetWithTremor",
       "DominantSideFirst", "LeftSideFirst", "RightSideFirst", "BothSidesFirst",
       "HallucinationWithDrugs", "HallucinationsWithoutDrugs", "depressionBefore",
       ...
       "RestTremor", "ProgressiveDosirder", "levodopaChorea", "levodopa5PlusYears", "Course10+",
  ...
  public static String[] IGNORE =
      {"UniqueID", "FamID", "IndID", "Site", "OnsetDate", "DiagnosisDate", "ExamDate", "Dx",
       "Gender", "BirthMonth", "BirthDay", "BirthYear", "Race", "OtherLRRK2", "InitialSymptom",
       "Levodopa(mg)", "Levodopa(yrs)", "Speech", "Salivation", "Swallowing", "Handwriting",
       "Utensils", "Dressing", "Hygiene", "BedTurning", "Falling", "FreezeWalk", "RightHanded",
       "Walking", "Tremor", "Sensory", "Speech_motor", "FacialExpression", "T_face", "T_r_hand",
       "T_l_hand", "T_r_foot", "T_l_foot", "PT_r_hand", "PT_l_hand", "R_neck", "R_r_ue", "R_l_ue",
       "R_r_le", "R_l_le", "FingerTabsR", "FingerTapsL", "HandR", "HandL", "RapidAltR", "RapidAltL",
       "LegR", "LegL", "Arising", "Posture", "Gait", "PosturalStability", "BradykinesiaUPDRS",
       "Ethnicity", "Onset>20", "S_Examiner_dur", "S_Subject_dur", "HY_dur", "S_Examiner_durAOO",
       "S_Subject_durAOO", "HY_durAOO", "S_Examiner_regress", "S_Subject_regress", "HY_regress",
       "S_Examiner_regressAOO", "S_Subject_regressAOO", "HY_regressAOO", "MMSEcutoff",
       "MMSE_edu_adj", "ExpressionScore", "ChairScore", "PostureScore", "GaitScore",
       "InstabilityScore", "APOE"};
    ...
    for (int pheno = 0; pheno < phenos.length; pheno++) {
      try {
        ...
        if (v.size() > 2) {
          ...
          lowestVal =
              Integer.valueOf(v.elementAt(0))
                     .intValue() < Integer.valueOf(v.elementAt(1)).intValue()
                                                                              ? Integer.valueOf(v.elementAt(0))
                                                                                       .intValue()
