...
/**
 * @author lane0212 fairly specific class that uses the results of {@link VCFSimpleTally} to find
 *         genes with potential compound hets in tumor normal subsets<br>
...
public class TNHetDetector {
  ...
  private static void filter(String vcfTumor, String vcfNormals, String vcfPop, String outputDir,
    ...
    VCFSimpleTally.test(output, new String[] {outCase}, omimDir, otherGenesOfInterest, null, maf,
                        true, true, null, false, new HashSet<>(), 24);
  }
