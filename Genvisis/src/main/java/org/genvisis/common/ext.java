...
public class ext {
  ...
  public static String formatTimeElapsed(long timeElapsed, TimeUnit elapsedUnit) {
    ...
    switch (elapsedUnit) {
      ...
      case HOURS:
        ...
        break;
      case MICROSECONDS:
        elapsed = TimeUnit.MICROSECONDS.toMillis(timeElapsed) > 9 ? formatMillisElapsed(timeElapsed
                                                                                        / 1000)
                                                                  : (timeElapsed + " µs");
        break;
      case MILLISECONDS:
      ...
      case MINUTES:
        ...
        break;
      case NANOSECONDS:
        elapsed = TimeUnit.NANOSECONDS.toMillis(timeElapsed) > 9 ? formatMillisElapsed(timeElapsed
                                                                                       / 1000000)
                                                                 : (timeElapsed + " ns");
        break;
      case SECONDS:
  ...
  public static String formatMinutesElapsed(long minsElapsed) {
    ...
    if (timeElapsed < 24 * 60) {
      ...
      return hrs + " hr" + (hrs > 1 ? "s " : " ") + (timeElapsed - (hrs * 60)) + " min";
    }
