...
/**
 * Author: Rohit Sinha Class to maintain a Boolean Map of Chr Positions. The outer Hashtable houses
 * the data for each of the chromosomes (Byte) separately. The inner Hashtable flags each position
 * (Integer) as being inside of a DHS region (Boolean, true/false)
 */
