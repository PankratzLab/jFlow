...
public class Alleles {
	public static char[] getAllelesInOrder(char a1, char[] bothAlleles) {
		...
		System.err.println("Error - Allele 1 ("+a1+") does not match with either of the alleles provided ("+bothAlleles[0]+"/"+bothAlleles[1]+")");
	...
	public static String[] getAlleleFreqForA1(String a1, String[] bothAllelesAndFreqForFirst) {
		...
		if (a1.charAt(0) == bothAllelesAndFreqForFirst[1].charAt(0)) {
			if (bothAllelesAndFreqForFirst[2].equals("NA")) {
				...
				if (decimalPos == -1) {
					if (bothAllelesAndFreqForFirst[2].equals("1") || bothAllelesAndFreqForFirst[2].equals("2")) {
						sigFigs = 0;
					} else {
		...
		System.err.println("Error - Allele 1 ("+a1+") does not match with either of the alleles provided ("+bothAllelesAndFreqForFirst[0]+"/"+bothAllelesAndFreqForFirst[1]+")");
