		...
		try {
			...
			for (int i = 0; i<numFiles; i++) {
				...
				for (int j = 0; j<line.length-2; j++) {
					...
					writers[i].println("java -classpath /home/npankrat/" + org.genvisis.common.PSF.Java.GENVISIS + " park.PermuteNullDistribution file="+line[2+((j+i*increment)%(line.length-2))]+".dat reps="+numReps+" perFamReps="+perFamReps+" bootReps="+bootReps);
