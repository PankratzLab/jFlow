...
public class SeqMetaPrimary {
  ...
  public static void batchMany(String cohort, String genos, String phenosCommaDelimited,
      String racesCommaDelimited, String snpInfo, int qsubMem, double qsubWalltime, String queue) {
    String[] phenos, races;
    Vector<String> v;
  ...
  public static void main(String[] args) {
    ...
    String usage =
        "\n" + "gwas.SeqMetaPrimary requires 4 arguments\n" + "   (1) cohort name (i.e. cohort="
            + cohort + " (not the default))\n" + "   (2) genotype file name (i.e. geno=" + genos
            + " (not the default))\n" + "   (3) phenotype file name (i.e. pheno=" + pheno
            + " (not the default))\n" + "   (4) snpInfo file name (i.e. snpInfo=" + snpInfo
            + " (not the default))\n" + "   (5) qsub memory in megabytes (i.e. qsubmem=" + qsubMem
