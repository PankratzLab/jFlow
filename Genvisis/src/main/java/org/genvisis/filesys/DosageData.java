...
public class DosageData implements Serializable {
	...
	public static DosageData combine(	DosageData dd1, DosageData dd2, COMBINE_OP onDupeOp,
		...
		System.gc();
		ddNew.genotypeProbabilities = ddNew.genotypeProbabilities == null	? null
																																			: Sort.putInOrder(ddNew.genotypeProbabilities,
																																												keys);
		System.gc();
		ddNew.dosageValues = ddNew.dosageValues == null	? null
																										: Sort.putInOrder(ddNew.dosageValues, keys);
		System.gc();
