...
public class Lookup {
	...
	public static Hashtable<String, String> lookupDNABatch(java.util.Collection<String> ids, Project project) {
		SampleData sd = project.getSampleData(0, false);
		Hashtable<String, String> lookupTable = new Hashtable<String, String>();
		for (String key : ids) {
			lookupTable.put(key, sd.lookup(key)[0]);
	...
	public static Hashtable<String, String> lookupIDsBatch(java.util.Collection<String> dnas, Project project) {
		SampleData sd = project.getSampleData(0, false);
		Hashtable<String, String> lookupTable = new Hashtable<String, String>();
		for (String key : dnas) {
			lookupTable.put(key, sd.lookup(key)[1]);
	...
	public static Hashtable<String, String> lookupIIDsOnlyBatch(java.util.Collection<String> dnas, Project project) {
		SampleData sd = project.getSampleData(0, false);
		Hashtable<String, String> lookupTable = new Hashtable<String, String>();
		for (String key : dnas) {
			lookupTable.put(key, sd.lookup(key)[2]);
