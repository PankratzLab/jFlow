  ...
  private static boolean[] loadSamples(Project proj, String samplesFile, DEMO_TYPE dType) {
    ...
    if (samplesFile != null) {
      ...
      if (dType == DEMO_TYPE.SAMPLE_FOCUS) {
        ...
        proj.getLog()
            .reportTimeInfo("A sample subset file was not provided, exporting all samples for demotype "
  ...
  private static String[] loadMarkers(Project proj, String markersFile, DEMO_TYPE dType) {
    ...
    if (markersFile != null) {
      ...
      if (dType == DEMO_TYPE.MARKER_FOCUS) {
        ...
        proj.getLog()
            .reportTimeInfo("A marker subset file was not provided, exporting all markers for demotype "
