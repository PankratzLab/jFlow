...
public class GenvisisWorkflow {
  ...
  static final STEP S1I_CREATE_MKR_POS =
                                       new STEP("Create Marker Positions (if not already exists)",
                                         ...
                                         public boolean[][] checkRequirements(Project proj,
                                                                              ...
                                                                              HashMap<STEP, ArrayList<String>> variables) {
                                           return new boolean[][] {{Files.exists(variables.get(this)
                                                                                          .get(0))}};
                                         }
                                         ...
                                         public boolean checkIfOutputExists(Project proj,
                                                                            HashMap<STEP, ArrayList<String>> variables) {
                                           boolean mkrPosFile =
                                                              Files.exists(proj.MARKER_POSITION_FILENAME.getValue(false,
                                                                                                                  false));
                                           // boolean mkrSetFile =
                                         ...
                                         public String getCommandLine(Project proj,
                                           ...
                                           String filename = variables.get(this).get(0);
                                           return Files.getRunString() + " cnv.manage.Markers proj="
                                                  + projFile + " snps=" + filename;
                                         }
  ...
  static final STEP S2A_PARSE_SAMPLES =
                                      new STEP("Parse Sample Files", "",
                                        ...
                                        public void setNecessaryPreRunProperties(Project proj,
                                          ...
                                          try {
                                            numThreads =
                                                       Integer.parseInt(variables.get(this).get(1));
                                          } catch (NumberFormatException e) {
                                          }
                                          if (numThreads != proj.NUM_THREADS.getValue()) {
                                            proj.NUM_THREADS.setValue(numThreads);
                                        ...
                                        public void run(Project proj,
                                          ...
                                          proj.getLog().report("Parsing sample files");
                                          int retCode =
                                                      org.genvisis.cnv.manage.SourceFileParser.createFiles(proj,
                                                                                                           numThreads);
                                          switch (retCode) {
                                            case 0:
                                              setFailed();
                                        ...
                                        public boolean[][] checkRequirements(Project proj,
                                          ...
                                          return new boolean[][] {{Files.exists(ext.verifyDirFormat(variables.get(this)
                                                                                                             .get(0))),},
                                                                  {numThreads > 0}};
                                        }
                                        ...
                                        public boolean checkIfOutputExists(Project proj,
                                          ...
                                          String sampleDirectory =
                                                                 proj.SAMPLE_DIRECTORY.getValue(false,
                                                                                                false);
                                          boolean mkrSetFile =
                                                             Files.exists(proj.MARKERSET_FILENAME.getValue(false,
                                                                                                           false));
                                        ...
                                        public String getCommandLine(Project proj,
                                          ...
                                          command.append(Files.getRunString())
                                                 ...
                                                 .append(projPropFile).append(" threads=")
                                                 .append(numThreads);
                                          return command.toString();
                                        }
  ...
  static final STEP S5_COMPUTE_GCMODEL =
                                       new STEP("Compute GCMODEL File", "",
                                         ...
                                         public boolean[][] checkRequirements(Project proj,
                                           ...
                                           String gcBaseFile = variables.get(this).get(0);
                                           String gcOutputFile = variables.get(this).get(1);
                                           return new boolean[][] {{Files.exists(gcBaseFile)},
                                                                   {!Files.exists(gcOutputFile)}};
                                         }
                                         ...
                                         public String getCommandLine(Project proj,
                                           ...
                                           if (kvCmd.length() > 0) {
                                             cmd.append(Files.getRunString())
                                                .append(" cnv.filesys.Project proj=" + projPropFile)
                                                .append(kvCmd).append("\n");
                                           }
                                           String gcBaseFile = variables.get(this).get(0);
                                           return cmd.append(Files.getRunString())
                                                     .append(" cnv.analysis.PennCNV proj="
                                                             + proj.getPropertyFilename() + " log="
  ...
  static final STEP S10_RUN_PLINK =
                                  new STEP("Create PLINK Files", "",
                                    ...
                                    public void run(Project proj,
                                      ...
                                      boolean create =
                                                     PlinkData.saveGenvisisToPlinkBedSet(proj,
                                                                                         "plink/plink",
                                                                                         null, null,
                                                                                         -1, true);
                                      if (!create) {
                                    ...
                                    public boolean[][] checkRequirements(Project proj,
                                      ...
                                      String pedFile = variables.get(this).get(0);
                                      STEP parseStep =
                                                     stepSelections.containsKey(S2I_PARSE_SAMPLES) ? S2I_PARSE_SAMPLES
                                                                                                   : S2A_PARSE_SAMPLES;
                                      boolean checkStepParseSamples = stepSelections.get(parseStep)
                                    ...
                                    public boolean checkIfOutputExists(Project proj,
                                      ...
                                      boolean pedCheck = Boolean.valueOf(variables.get(this)
                                    ...
                                    public String getCommandLine(Project proj,
                                      ...
                                      if (kvCmd.length() > 0) {
                                        cmd.append(Files.getRunString())
                                           .append(" cnv.filesys.Project proj=")
  ...
  static final STEP S14_CREATE_PCS =
                                   new STEP("Create Principal Components File and Mitochondrial Copy-Number Estimates File",
                                     ...
                                     public void setNecessaryPreRunProperties(Project proj,
                                                                              HashMap<STEP, ArrayList<String>> variables) {
                                       double sampleLRRSdFilter =
                                                                Double.parseDouble(variables.get(this)
                                                                                            .get(1));
                                       if (sampleLRRSdFilter < 0) {
                                         switch (proj.ARRAY_TYPE.getValue()) {
                                           ...
                                           case AFFY_GW6_CN:
                                             ...
                                             proj.getLog()
                                                 .reportTimeInfo("Setting "
                                                                 + proj.LRRSD_CUTOFF.getName()
                                                                 + " to default 0.35 for array "
                                     ...
                                     public void run(Project proj,
                                       ...
                                       double markerCallRateFilter =
                                                                   Double.parseDouble(variables.get(this)
                                                                                               .get(2));
                                       boolean gcCorrect = Boolean.valueOf(variables.get(this)
                                                                                    .get(3));
                                       boolean imputeMeanForNaN =
                                                                Boolean.valueOf(variables.get(this)
                                                                                         .get(4));
                                       boolean recomputeLRR_PCs =
                                                                Boolean.valueOf(variables.get(this)
                                                                                         .get(5));
                                       boolean recomputeLRR_Median =
                                                                   Boolean.valueOf(variables.get(this)
                                                                                            .get(6));
                                       boolean homozygousOnly = Boolean.valueOf(variables.get(this)
                                                                                         .get(7));
                                       int bpGcModel =
                                                     GcAdjustor.GcModel.DEFAULT_GC_MODEL_BIN_FASTA;// Integer.parseInt(variables.get(this).get(8));
                                       ...
                                       int numThreads =
                                                      Integer.parseInt(variables.get(this).get(9));
                                       ...
                                       boolean plot = false;
                                       int retCode = PCAPrep.prepPCA(proj, numThreads, outputBase,
                                                                     markerQC, markerCallRateFilter,
                                                                     useFile, proj.getSampleList(),
                                                                     proj.getLog());
                                       if (retCode == 42) { // TODO remove magic number
                                         MitoPipeline.estimateMtDNACN(proj, numThreads,
                                                                      medianMarkers, numComponents,
                                                                      outputBase, homozygousOnly,
                                                                      markerCallRateFilter,
                                                                      betaOptFile, pedFile,
                                                                      recomputeLRR_PCs,
                                                                      recomputeLRR_Median, sampLrr,
                                                                      imputeMeanForNaN, gcCorrect,
                                                                      refGenomeFasta, bpGcModel,
                                                                      regressionDistance,
                                     ...
                                     public boolean[][] checkRequirements(Project proj,
                                       ...
                                       try {
                                         regressionDistance = Integer.parseInt(variables.get(this)
                                                                                        .get(8));
                                       } catch (NumberFormatException e) {
                                       }
                                       try {
                                       ...
                                       return new boolean[][] {{(stepSelections.get(S4_TRANSPOSE_TO_MDF)
                                                                 && S4_TRANSPOSE_TO_MDF.hasRequirements(proj,
                                                                                                        stepSelections, variables))
                                                                || Files.exists(markerDir)},
                                                               {Files.exists(medianMkrs)},
                                                               {lrrThresh > 0}, {callrate > 0},
                                                               {true}, // TRUE or FALSE are both
                                                                       // valid selections
                                                               {true}, {true}, {true}, {true},
                                                               {regressionDistance > 0},
                                                               {numThreads > 0},
                                                               {betaOptFile.equals("")
                                                                || Files.exists(betaOptFile)},
                                                               {betaFile.equals("")
                                                                || Files.exists(betaFile)},};
                                     }
                                     ...
                                     public String getCommandLine(Project proj,
                                       ...
                                       String medianMarkers = variables.get(this).get(0);
                                       double lrrSD =
                                                    Double.parseDouble(variables.get(this).get(1));
                                       double markerCallRateFilter =
                                                                   Double.parseDouble(variables.get(this)
                                                                                               .get(2));
                                       boolean gcCorrect = Boolean.valueOf(variables.get(this)
                                       ...
                                       cmd.append(Files.getRunString())
                                          ...
                                          .append(" recomputeLRR_Median=")
                                          .append(recomputeLRR_Median).append(" gcCorrect=")
                                          .append(gcCorrect).append(" bpGcModel=").append(bpGcModel)
                                          ...
                                          .append(" sampLRR=").append(sampLrr).append(" threads=")
                                          .append(numThreads).append(" log=")
                                          .append(proj.getLog().getFilename()).append(" output=")
                                          .append(outputBase);
                                       if (!"".equals(betaOptFile)) {
                                         cmd.append(" ").append(MitoPipeline.PC_OPT_FILE)
                                            .append("=").append(betaOptFile);
                                       }
                                       if (!"".equals(betaFile)) {
  ...
  static final STEP S16_SEX_CENTROIDS_PFB_GCMODEL =
                                                  new STEP("Create Sex-Specific Centroids; Filter PFB and GCMODEL Files",
                                                    ...
                                                    public void setNecessaryPreRunProperties(Project proj,
                                                      ...
                                                      try {
                                                        numThreads =
                                                                   Integer.parseInt(variables.get(this)
                                                                                             .get(1));
                                                      } catch (NumberFormatException e) {
                                                      }
                                                      if (numThreads != proj.NUM_THREADS.getValue()) {
                                                    ...
                                                    public boolean[][] checkRequirements(Project proj,
                                                                                         HashMap<STEP, Boolean> stepSelections,
                                                                                         HashMap<STEP, ArrayList<String>> variables) {
                                                      boolean checkStepGCModel =
                                                                               stepSelections.get(S5_COMPUTE_GCMODEL)
  ...
  private static STEP[] ILLUMINA_STEPS =
                                       {S1I_CREATE_MKR_POS, S2I_PARSE_SAMPLES, S3_CREATE_SAMPLEDATA,
                                        S4_TRANSPOSE_TO_MDF, S5_COMPUTE_GCMODEL, S6_SAMPLE_QC,
                                        S7_MARKER_QC, S8_SEX_CHECKS, S9_GENERATE_ABLOOKUP,
                                        S10_RUN_PLINK, S11_GWAS_QC, S12_MOSAIC_ARMS,
