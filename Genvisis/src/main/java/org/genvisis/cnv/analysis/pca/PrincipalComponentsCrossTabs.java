 ...
 * sample QC and other metrics TODO , implement a pc-selector based of thresholds....
 */
public class PrincipalComponentsCrossTabs extends PrincipalComponentsResiduals {
	...
	private final SampleQC sampleQC;
	...
	public static void guiAccess(Project proj, Component parentComponent) {
		...
		if (Files.exists(pcFile)) {
			...
			// int promptResult = JOptionPane.showOptionDialog(parentComponent, "Generate cross tabs plots
	...
	public static void main(String[] args) {
		...
		for (String arg : args) {
			if (arg.equals("-h") || arg.equals("-help") || arg.equals("/h") || arg.equals("/help")) {
				...
				numArgs--;
			} else if (arg.startsWith("alternateDataFile=")) {
				alternateDataFile = ext.parseStringArg(arg, "");
				numArgs--;
