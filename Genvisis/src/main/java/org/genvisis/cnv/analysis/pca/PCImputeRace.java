...
public class PCImputeRace {
  ...
  private final int[] europeanSeeds;

  private final int[] africanSeeds;

  private final int[] asianSeeds;
  ...
  private boolean maybeSwapPCs() {
    double[] europeanPC1 = new double[europeanSeeds.length],
        europeanPC2 = new double[europeanSeeds.length];
    double[] africanPC1 = new double[africanSeeds.length],
        africanPC2 = new double[africanSeeds.length];
