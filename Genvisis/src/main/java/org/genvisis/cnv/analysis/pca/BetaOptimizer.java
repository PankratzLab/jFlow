...
public class BetaOptimizer {
    ...
    for (String betaFile : betaFiles) {
      ...
      if (!Files.exists(bigSummaryOut)) {
        ...
        try {
          ...
          boolean[] samplesForModels = ArrayUtils.booleanArray(proj.getNumberOfParsedSamples(),
                                                               false);
          ...
          int[] indicesPC = ext.indexLargeFactors(pcSamps, proj.getSamples(), true, proj.getLog(),
                                                  true);
          boolean[] sampsPCs = ArrayUtils.booleanArray(proj.getNumberOfParsedSamples(), false);
  ...
  private static ArrayList<MetaBeta> loadBetas(List<MarkerRsFormat> markerRsFormats,
                                               ...
                                               MarkerSetInfo markerSet, Logger log) {
  ...
  public static class MarkerRsFormat implements Serializable {
    ...
    public static List<MarkerRsFormat> readSerial(String fileName, Logger log) {
      return (ArrayList<MarkerRsFormat>) SerializedFiles.readSerial(fileName, log, false, true);
    }
