...
public abstract class Requirement {
	...
	public abstract static class RequirementSet {
		...
		void stubUsageForPedigree() {
			...
			RequirementSet overall = new OrRequirementSet();
			RequirementSet rs2 = new AndRequirementSet(), rs21 = new OrRequirementSet(), rs3 = new AndRequirementSet();
