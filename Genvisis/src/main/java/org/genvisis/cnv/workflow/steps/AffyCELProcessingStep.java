...
import org.genvisis.cnv.affy.APTAffy6Pipeline;
...
public class AffyCELProcessingStep extends Step {
  ...
  public void run(Variables variables) {
    ...
    try {
      APTAffy6Pipeline.run(proj, aptExeDir, aptLibDir, quantNormTarget, full, null, numThreads);
    } catch (Elision e) {
  ...
  public String getCommandLine(Variables variables) {
    ...
    cmd.append(" ").append(APTAffy6Pipeline.class.getName());
