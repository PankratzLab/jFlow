...
public class CytoCNVariant extends CNVariant {
    ...
    try {
      ...
      do {
        ...
        count++;
               ...
               && (ext.indexFactors(CYTO_ABERATION_HEADER, line, false, true, false)[0] == -1));
      if (!reader.ready()) {
  ...
  public static void writeToPlink(CytoCNVariant[] CytoCNVariant, String fileName, Logger log) {
    try {
      ...
      for (org.genvisis.cnv.cyto.CytoCNVariant element : CytoCNVariant) {
