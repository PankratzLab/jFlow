...
public class BlastAnnotationTypes {
  ...
  public enum BLAST_ANNOTATION_TYPES {
     ...
     *
     */
    PERFECT_MATCH(VCFHeaderLineType.String, DEFAULT_COUNT, DEFAULT_NUMBER,
                  "Alignments (Cigar-positive orientation, Segment - positive orientation, Strand -original orientation) that perfectly cover the region",
                  ANNO_DELIM, DEFAULT_VALUE),
