 ...
 * 
 * Why WBS instead of Circular Binary Segmentation (CBS)? It addresses similar issues as CBS
 * (through an initial random interval scan - hence "Wild") and is _much_ easier to implement.
 * https://github.com/cran/wbs/
 * 
 * Compare to DNACopy fortran +R code
