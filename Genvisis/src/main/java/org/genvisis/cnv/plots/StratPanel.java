...
//												  new Color(126, 37, 131)};	// red purple
	...
	private StratPlot sp;
	private SampleData sampleData;
	private CountVector classCounts;
...
//				menu.add(new LaunchAction(proj.getProjectDir()+StratPlot.DEFAULT_FILENAME, proj, samples[prox.elementAt(i)], colorHash.containsKey(samples[prox.elementAt(i)][0]+"\t"+samples[prox.elementAt(i)][1])?colorScheme[Integer.parseInt(colorHash.get(samples[prox.elementAt(i)][0]+"\t"+samples[prox.elementAt(i)][1]))]:Color.GRAY));
			}
