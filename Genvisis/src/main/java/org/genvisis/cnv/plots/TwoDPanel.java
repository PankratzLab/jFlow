...
public class TwoDPanel extends AbstractPanel implements MouseListener, MouseMotionListener {
  ...
  public static final Color[] DEFAULT_COLORS = {BLUES.MIDNIGHT_EXPRESS, // dark dark
                                                ...
                                                BLUES.CORNFLOWER_BLUE, BLUES.DARK_SLATE_BLUE,
                                                BLUES.SLATE_BLUE, BLUES.MEDIUM_SLATE_BLUE,
                                                BLUES.LIGHT_SLATE_BLUE, BLUES.MEDIUM_BLUE,
                                                BLUES.ROYAL_BLUE, Color.BLUE, BLUES.DODGER_BLUE,
                                                BLUES.DEEP_SKY_BLUE, BLUES.LIGHT_SKY_BLUE,
                                                BLUES.LIGHT_SKY_BLUE, BLUES.STEEL_BLUE,
                                                BLUES.LIGHT_STEEL_BLUE, BLUES.LIGHT_BLUE,
                                                BLUES.POWDER_BLUE, BLUES.PALE_TURQUOISE,
                                                BLUES.DARK_TURQUOISE, BLUES.MEDIUM_TURQUOISE,
                                                BLUES.TURQUOISE, BLUES.AQUA, BLUES.LIGHT_CYAN,
