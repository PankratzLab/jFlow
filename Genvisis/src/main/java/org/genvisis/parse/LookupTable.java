...
public class LookupTable {
  public static void fromParameters(String filename, Logger log) {
    ...
    params = Files.parseControlFile(filename, "lookup",
        new String[] {
            "topHits.txt 0 out=results.xln head=IID missingValue=. ignoreCase noFinalHeader hideIndex lessMemoryButSlower keepIntermediateFiles",
            "F7_SingleSNP.csv , 1 3=MAF", "plink.bim noHeader 1 0=Chr 3=loc_36.1", "freq.frq 1 4",
            "plink.assoc 1 4 5 8 3", "logistic.xls 0 4 6 7 9 10 12",
            ...
            "missing.lmiss 1 4=MissingRate", "hardy.hwe !2=UNAFF 1 8=HWE_pvalue",
