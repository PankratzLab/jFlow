...
// */
// public class IPV {
// // print $convertedTsv "Variant Alleles"."\t"."Coding Start"."\t"."Validation
// Status"."\t"."Strand"."\t"."Gene Location(Transcript
// Strand)"."\t"."TranscriptID"."\t"."polyphen2"."\t"."sift"."\t"."rsID"."\t"."Variation
// Source"."\n";
//
...
// "UCSC" };
//
// private static final String[] ANNO = new String[] { "SNPEFF_AMINO_ACID_CHANGE",
// "SNPEFF_TRANSCRIPT_ID", "LJB23_Polyphen2_HDIV_score", "LJB23_SIFT_score", "snp138",
// "AAChange.refGene" };
//
// private static void generate(String[] vcfs, String outputTSV, String[] geneNames,
...
// String variantAlleles = vc.getReference().getBaseString() + "/" +
...
// String[] vcfs = new String[] { dir + "OSTEO_OFF_INHERIT.final.vcf.gz", dir +
// "OSTEO_OFF_INHERIT_CONTROL.final.vcf.gz" };
// String dirOut = "/panfs/roc/groups/5/pankrat2/lanej/test/IPV_TEST/ipv/circos-p/Input/";
//
// Logger log = new Logger(dir + ".log");
// VARIANT_FILTER_BOOLEAN[] bFilters = new VARIANT_FILTER_BOOLEAN[] {
// VARIANT_FILTER_BOOLEAN.BIALLELIC_FILTER };
// String[][] jexl = VCFSimpleTally.getG1000ESPFilter(0.01);
// String[] genes = new String[] { "RECQL4" };
// VariantContextFilter filter = new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] {}, bFilters,
// jexl[0], jexl[1], log);
