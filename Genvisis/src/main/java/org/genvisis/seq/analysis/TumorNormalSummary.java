...
public class TumorNormalSummary {
	...
	private static final String[] BASE_OUT = new String[] { "CHROM", "POS", "ID", "REF", "FULL_ALT", "ALT", "HIGH||MODERATE||LOW", "TN_PAIR", "NORMAL_SAMPLE", "TUMOR_SAMPLE", "NORMAL_GENOTYPE", "TUMOR_GENOTYPE", "NORMAL_GQ", "TUMOR_GQ", "NORMAL_HAS_ALT", "TUMOR_HAS_ALT", "MIN_GQ", "TN_MATCH" };

	private static void run(String vcf, String vpopFile, String outputDir, Segment seg, String name, int buffer, Logger log) {
		...
		CloseableIterator<VariantContext> iter = reader.query(Positions.getChromosomeUCSC(segBuffer.getChr(), true), segBuffer.getStart(), segBuffer.getStop());
		try {
				...
				if (!vc.isMonomorphicInSamples()) {
					...
					for (String tnPair : vpop.getSubPop().keySet()) {
						...
						if (!vcTNPair.isMonomorphicInSamples()) {
							...
							// private static final String[] BASE_OUT = new String[] { "CHROM", "POS", "ID", "REF", "ALT", "TN_PAIR", "NORMAL_GENOTYPE", "TUMOR_GENOTYPE", "TN_MATCH" };
							...
							builder.append("\t" + (impact.equals("HIGH") || impact.equals("MODERATE") || impact.equals("LOW")));
	...
	public static void main(String[] args) {
		...
		Segment[] segs = new Segment[] { new Segment("chr15:50714579-50795277"), new Segment("chr8:143543377-143628368") };
