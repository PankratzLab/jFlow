...
public class VCFHistogram implements Serializable {
  ...
  public static void createHistograms(String vcf, String vpop, String outputDir, String outputRoot,
    ...
    VariantFilterSample[] vfSamples = new VariantFilterSample[] {new AricWesFilter(log).getARICVariantContextFilters(),
                                                                 null};
    ...
    try (WorkerTrain<VCFHistogram> train = new WorkerTrain<>(producer, numthreads, numthreads,
                                                             log)) {
