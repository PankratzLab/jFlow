...
/**
 * @author lane0212<br>
 *         Supplies a lookup for Fasta formatted nucleotides, useful when a position can be multiple nucleotides such as Affy Probe sequences<br>
 * 
 *         We do not handle "U" - only handling ACTG combos
 */
public class SequenceLookup {
	private Hashtable<String, String> nucleotideLookup;
	private Logger log;

	public SequenceLookup( Logger log) {
		super();
		this.nucleotideLookup = getNucleotideLookup();
		this.log = log;
	}

	/**
	 * @param combo
	 *            such as "AG" meaning A or G, and "AT" meaning A or T
