...
public class SkatMetaPrimary {
  ...
  public static void batch(String cohort, String genos, String phenoFilename, String snpInfo,
    ...
    try {
      ...
      Qsub.qsubMultiple(jobNamesWithAbsolutePaths, jobSizes, batchDir, batchDir + "chunk_" + cohort,
                        8, true, null, -1, qsubMem, qsubWalltime);
