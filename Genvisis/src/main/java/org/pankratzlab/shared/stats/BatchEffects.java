...
public class BatchEffects {
  ...
  public static void main(String[] args) throws FileNotFoundException, ParseException, IOException,
    ...
    if (cli.has("batchFilePath") && cli.has("factorFilePath")) {
      ...
      BatchEffects instance = builder.build(cli.get("batchFilePath"), cli.get("factorFilePath"));
   ...
   * sampleMembership. sampleMembership and sampleValues should have parallel indices, each index
   * representing a specific sample. if sampleMembership and sampleValues arguments are both size 0,
   * then a two-dimensional array will be returned that contains two arrays of length 0.
   * 
