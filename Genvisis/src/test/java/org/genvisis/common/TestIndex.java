...
public class TestIndex {
  ...
  /**
   * Benchmark {@link ext#indexLargeFactors(String[], String[], boolean, Logger, boolean)}
   */
  ...
  public void exactMatch() {
    ...
    reportIndex(i2d + " - exact", 2, ext.indexFactors(new String[][] {{query}, {query}}, superset,
                                                      true, true, false)[0]);
    reportIndex(i2d + " - fuzzy", 1, ext.indexFactors(new String[][] {{query}, {query}}, superset,
                                                      true, false, false)[0]);
  }
  ...
  public void caseSensitive() {
    ...
    reportIndex(i1d + sen, 3,
                ext.indexFactors(new String[] {query}, superset, true, new Logger(), false)[0]);
    reportIndex(i1d + ins, 0,
                ext.indexFactors(new String[] {query}, superset, false, new Logger(), false)[0]);
    reportIndex(i2d + sen, 3, ext.indexFactors(new String[][] {{query}, {query}}, superset, true,
                                               true, false)[1]);
    reportIndex(i2d + ins, 0, ext.indexFactors(new String[][] {{query}, {query}}, superset, false,
                                               true, false)[1]);
  }
