...
public class TestAncestryPCA {
   ...
   */
  private static final double[][] ADDITIONAL_SAMPLES = new double[][] {{0, 1, 2, 2, 1, 2, 0, 0,
                                                                        Double.NaN, 2, 1},
                                                                       {0, Double.NaN, 2, 2, 1, 2,
                                                                        0, 0, 1, 0, 0}};
  ...
  private void comparePCsToStandard(DenseMatrix64F pcs, double[][] standardPCs) {
    for (int component = 0; component < pcs.numCols; component++) {//
      boolean flip = false;

      for (int sample = 0; sample < pcs.numRows; sample++) {
