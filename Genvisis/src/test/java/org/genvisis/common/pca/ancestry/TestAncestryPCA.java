...
public class TestAncestryPCA {
  ...
  public void testAncestryPCsAndLoadings() {
    ...
    InputProvider inputProvider2 = new InputProvider(inputWithNewSamples);
    NamedRealMatrix m2 = inputProvider2.getData();
    assertEquals(numberOfPCSamples + nonPCSamples, m2.getDenseMatrix().getNumCols());//2 new samples
