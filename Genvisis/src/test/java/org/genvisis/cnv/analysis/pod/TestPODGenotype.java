...
public class TestPODGenotype {
	...
	public void TestGetSharedAlleleCount() {
		...
		Assert.assertEquals(2,
												Genotype.getSharedAlleleCount(Genotype.AA, Genotype.AA)
																.getNumAlleleMatch());
		Assert.assertEquals(2,
												Genotype.getSharedAlleleCount(Genotype.AA, Genotype.AB)
																.getNumAlleleMatch());

		Assert.assertEquals(2,
												Genotype.getSharedAlleleCount(Genotype.BB, Genotype.BB)
																.getNumAlleleMatch());
		Assert.assertEquals(2,
												Genotype.getSharedAlleleCount(Genotype.BB, Genotype.AB)
																.getNumAlleleMatch());
		Assert.assertEquals(2,
												Genotype.getSharedAlleleCount(Genotype.AB, Genotype.AB)
																.getNumAlleleMatch());
		// child has one allele in common with parent

		Assert.assertEquals(1,
												Genotype.getSharedAlleleCount(Genotype.AB, Genotype.AA)
																.getNumAlleleMatch());
		Assert.assertEquals(1,
												Genotype.getSharedAlleleCount(Genotype.AB, Genotype.BB)
																.getNumAlleleMatch());
		// child has zero alleles in common with parent
		Assert.assertEquals(0,
												Genotype.getSharedAlleleCount(Genotype.BB, Genotype.AA)
																.getNumAlleleMatch());
		Assert.assertEquals(0,
												Genotype.getSharedAlleleCount(Genotype.AA, Genotype.BB)
																.getNumAlleleMatch());

		Assert.assertEquals(0,
												Genotype.getSharedAlleleCount(Genotype.NC, Genotype.AA)
																.getNumAlleleMatch());
		Assert.assertEquals(0,
												Genotype.getSharedAlleleCount(Genotype.NC, Genotype.AB)
																.getNumAlleleMatch());
		Assert.assertEquals(0,
												Genotype.getSharedAlleleCount(Genotype.NC, Genotype.BB)
																.getNumAlleleMatch());
	}
	...
	public void TestGetPodEffect() {
		for (Genotype g : PODGenotype.Genotype.values()) {
			Assert.assertEquals(true, PODGenotype.getPodEffect(g, g,
																												 BAF_EFFECT.INCREASE) == POD.NONE);
			Assert.assertEquals(true, PODGenotype.getPodEffect(g, g,
																												 BAF_EFFECT.DECREASE) == POD.NONE);
		}
		for (Genotype g : PODGenotype.Genotype.values()) {
			if (g != Genotype.BB) {
