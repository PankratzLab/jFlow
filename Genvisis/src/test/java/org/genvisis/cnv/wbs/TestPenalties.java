...
public class TestPenalties {
  ...
  private static final double[] ssicPenalty10 = new double[] {13.7369557145235, 16.4593666708363,
                                                              9.73237253432228, 5.65382432668327,
                                                              10.9068240999732, 8.67204118914339,
                                                              12.0315623218365, 15.199128698087,
                                                              20.4425461247536, 26.2228964160272,
                                                              30.9001999949233};
  private static final double[] bicPenalty10 = new double[] {13.7369557145235, 16.3591868292811,
                                                             9.53201285121201, 5.35328480201787,
                                                             10.5061047337527, 8.17114198136773,
                                                             11.4304832725057, 14.4978698072011,
                                                             19.6411073923125, 25.321277842031,
                                                             29.8984015793719

  };

  private static final double[] mbicPenalty10 = new double[] {13.7369557145235, 18.5179308860493,
                                                              13.156975619571, 10.35951676357,
                                                              16.9252533136841, 15.171865966202,
                                                              19.4396678496892, 23.6986163621237,
                                                              30.4756869417539, 37.0899236154787,
                                                              43.094460763058
  ...
  public void TestIcCurves() {
    ...
    for (PenalizedChangePoints penalizedChangePoints : wbsChangePoints.getPenalizedChangePoints()) {
      ...
      for (int i = 0; i < test.length; i++) {
        ...
        Assert.assertEquals(test[i], penalizedChangePoints.getIcCurve().get(i), 1e-12);
      }
      int i = 0;
