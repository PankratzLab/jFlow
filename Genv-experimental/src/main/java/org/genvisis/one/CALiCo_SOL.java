...
public class CALiCo_SOL {
   ...
   *          list of the files with the file name extension; 3) specify the full path of a file
   *          while leave directory as null, then you will know whether the file exists.
   * @param log
   * @return
   * @throws Elision
   */
  public static File[] getListOfFilesInADirectory(String directory,
                                                  final String filenameOrNameExtToList,
