...
public class MossyPlots {
	...
	private static void plot(Project proj, String mosBaseFile) {
		Set<String> tns = VcfPopulation.load(proj.PROJECT_DIRECTORY.getValue() + "TN.vpop", POPULATION_TYPE.TUMOR_NORMAL, proj.getLog()).getTumorSamples();
		...
		for (int i = 1; i < mos.length; i++) {
			...
			if (Double.parseDouble(mos[i][9]) >= 0) {
				String data = Array.toStr(mos[i]) + "\t" + (sampleData.individualShouldBeExcluded(mos[i][0]) ? 1 : 0) + "\t" + (tns.contains(mos[i][0]) ? "TUMOR" : "GERMLINE") + "\t" + mos[i][1].replaceAll("p", "").replaceAll("q", "");
				if (Double.parseDouble(mos[i][9]) >= .25) {
					geomTexts.add(new GeomText(Double.parseDouble(mos[i][3]), Double.parseDouble(mos[i][9]), .25, mos[i][1], .1));
				}
				filtered.add(data);
			}
		}
		...
		RScatter rsScatterAll = new RScatter(mosFile, tNAll + ".rscript", ext.rootOf(tNAll), tNAll + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "TUMOR", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		// Restrictions[] restrictionss = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new String[] { "true" }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTN = new RScatter(mosFile, tumorNormalNoExclude + ".rscript", ext.rootOf(tumorNormalNoExclude), tumorNormalNoExclude + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "TUMOR", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		rsScatterTN.setOverWriteExisting(true);
		rsScatterTN.setyRange(new double[] { 0, 1 });
		rsScatterTN.setxRange(new double[] { -.5, .5 });
		Restrictions[] restrictionTN = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNSamp = new RScatter(mosFile, tumorNormalNoExcludeSamp + ".rscript", ext.rootOf(tumorNormalNoExcludeSamp), tumorNormalNoExcludeSamp + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "Sample", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNSamp = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		double filter = 0.10;
		RScatter rsScatterTNFocus = new RScatter(mosFile, tumorNormalNoExcludeFocus + ".rscript", ext.rootOf(tumorNormalNoExcludeFocus), tumorNormalNoExcludeFocus + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "TUMOR", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions mm = new Restrictions(new String[] { "BpWeightedAverage" }, new double[] { filter }, new String[] { ">=" }, null);
		Restrictions[] restrictionTNFocus = new Restrictions[] { mm, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		double filter2 = 0.25;
		RScatter rsScatterTNFocus2 = new RScatter(mosFile, tumorNormalNoExcludeFocus2 + ".rscript", ext.rootOf(tumorNormalNoExcludeFocus2), tumorNormalNoExcludeFocus2 + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "Sample", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		// rsScatterTNFocus.setgTexts(geomTexts.toArray(new GeomText[geomTexts.size()]));
		// rsScatterTNFocus.setHorizontalLines(new HorizontalLine[] { horizontalLine });
		Restrictions mm2 = new Restrictions(new String[] { "BpWeightedAverage" }, new double[] { filter2 }, new String[] { ">=" }, null);
		Restrictions[] restrictionTNFocus2 = new Restrictions[] { mm2, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBandCompallColors = new RScatter(mosFile, tumorNormalNoExcludeCompallColors + ".rscript", ext.rootOf(tumorNormalNoExcludeCompallColors), tumorNormalNoExcludeCompallColors + ".jpeg", "SD of BAF (0.15-0.85)", new String[] { "IQR of BAF (0.15-0.85)" }, "TUMOR", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		//Restrictions[] restrictionTNCompallColors = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBandCompallNEColors = new RScatter(mosFile, tumorNormalNoExcludeCompnoEColors + ".rscript", ext.rootOf(tumorNormalNoExcludeCompnoEColors), tumorNormalNoExcludeCompnoEColors + ".jpeg", "SD of BAF (0.15-0.85)", new String[] { "IQR of BAF (0.15-0.85)" }, "TUMOR", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNCompallNEColors = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBandCompall = new RScatter(mosFile, tumorNormalNoExcludeCompall + ".rscript", ext.rootOf(tumorNormalNoExcludeCompall), tumorNormalNoExcludeCompall + ".jpeg", "SD of BAF (0.15-0.85)", new String[] { "IQR of BAF (0.15-0.85)" }, "BpWeightedAverage", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNCompall = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBandCompone = new RScatter(mosFile, tumorNormalNoExcludeCompone + ".rscript", ext.rootOf(tumorNormalNoExcludeCompone), tumorNormalNoExcludeCompone + ".jpeg", "SD of BAF (0.15-0.85)", new String[] { "IQR of BAF (0.15-0.85)" }, "BpWeightedAverage", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNCompone = new Restrictions[] { mm, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBandComp = new RScatter(mosFile, tumorNormalNoExcludeComp + ".rscript", ext.rootOf(tumorNormalNoExcludeComp), tumorNormalNoExcludeComp + ".jpeg", "SD of BAF (0.15-0.85)", new String[] { "IQR of BAF (0.15-0.85)" }, "BpWeightedAverage", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNComp = new Restrictions[] { mm2, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNFocus2arm = new RScatter(mosFile, tumorNormalNoExcludeFocus2arm + ".rscript", ext.rootOf(tumorNormalNoExcludeFocus2arm), tumorNormalNoExcludeFocus2arm + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "Band", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		rsScatterTNFocus2arm.setTitle("Samples with Mosaic Metric >=" + filter2 + " (Colored by chromosomal Arm)");
		rsScatterTNFocus2arm.setFontsize(14);
		rsScatterTNFocus2arm.setlPosition(LEGEND_POSITION.NONE);

		// rsScatterTNFocus.setgTexts(geomTexts.toArray(new GeomText[geomTexts.size()]));
		// rsScatterTNFocus.setHorizontalLines(new HorizontalLine[] { horizontalLine });
		Restrictions mm2arm = new Restrictions(new String[] { "BpWeightedAverage" }, new double[] { filter2 }, new String[] { ">=" }, null);
		Restrictions[] restrictionTNFocus2arm = new Restrictions[] { mm2arm, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNFocus2chr = new RScatter(mosFile, tumorNormalNoExcludeFocus2chr + ".rscript", ext.rootOf(tumorNormalNoExcludeFocus2chr), tumorNormalNoExcludeFocus2chr + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "Chr", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		rsScatterTNFocus2chr.setTitle("Samples with Mosaic Metric >=" + filter2 + " (Colored by chromosome)");
		rsScatterTNFocus2chr.setFontsize(14);
		// rsScatterTNFocus2chr.setlPosition(LEGEND_POSITION.NONE);
		// rsScatterTNFocus.setgTexts(geomTexts.toArray(new GeomText[geomTexts.size()]));
		// rsScatterTNFocus.setHorizontalLines(new HorizontalLine[] { horizontalLine });
		Restrictions mm2chr = new Restrictions(new String[] { "BpWeightedAverage" }, new double[] { filter2 }, new String[] { ">=" }, null);
		Restrictions[] restrictionTNFocus2chr = new Restrictions[] { mm2chr, new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatter rsScatterTNBand = new RScatter(mosFile, tumorNormalNoExcludeBand + ".rscript", ext.rootOf(tumorNormalNoExcludeBand), tumorNormalNoExcludeBand + ".jpeg", "mean LRR", new String[] { "BpWeightedAverage" }, "Band", SCATTER_TYPE.BASIC_POINT, proj.getLog());
		...
		Restrictions[] restrictionTNBand = new Restrictions[] { new Restrictions(new String[] { "Exclude" }, new double[] { 0 }, new String[] { "==" }, null) };
		...
		RScatters rScatters = new RScatters(rscScatters.toArray(new RScatter[rscScatters.size()]), finalRscript, finalout, COLUMNS_MULTIPLOT.COLUMNS_MULTIPLOT_1, PLOT_DEVICE.PDF, proj.getLog());
		rScatters.execute();
	}
...
//		generateGCModel(proj, new ReferenceGenome(proj.REFERENCE_GENOME_FASTA_FILENAME.getValue(), proj.getLog()), 1000000);
		...
		String[] mosResults = Files.list(proj.RESULTS_DIRECTORY.getValue(), "Mosaicism", ".xln", true, false, true);
		for (int i = 0; i < mosResults.length; i++) {
			plot(proj, mosResults[i]);
		}
