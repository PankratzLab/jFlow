...
public class TestMutInd {
	...
	private static void run(String vcf, String outputDir, Logger log, VcfPopulation vpop, double maf) {
		VariantContextFilter filter = new VariantContextFilter(new VARIANT_FILTER_DOUBLE[] {},
				new VARIANT_FILTER_BOOLEAN[] { VARIANT_FILTER_BOOLEAN.FAILURE_FILTER }, new String[] { "Freq" },
