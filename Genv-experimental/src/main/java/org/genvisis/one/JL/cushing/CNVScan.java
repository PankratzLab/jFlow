...
public class CNVScan {
  ...
  public static void main(String[] args) {
    ...
    vpop.report();
    HashSet<String> lqs = HashVec.loadFileToHashSet("/Volumes/Beta2/NGS/Cushings/cnvs/CUSHING_FREQ_V3.lowerQualitySamples.txt",
                                                    false);
    Map<String, LocusSet<CNVariant>> set = CNVariant.breakIntoInds(LocusSet.combine(CNVariant.loadLocSet(cnvFile,
                                                                                                         log),
    ...
    splitIntoCaseControl(log, vpop, set, cushings, controls, "CUSHING_FREQ_V3", notControls, lqs);
  ...
  private static void splitIntoCaseControl(Logger log, VcfPopulation vpop,
                                           Map<String, LocusSet<CNVariant>> set,
                                           List<CNVariant> cushings, List<CNVariant> controls,
                                           String caseDef, HashSet<String> notControls,
                                           HashSet<String> lq) {
  ...
  private static ArrayList<CNVariant> filterOutControls(List<CNVariant> caseSet,
