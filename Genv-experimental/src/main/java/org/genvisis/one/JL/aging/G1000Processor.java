...
public class G1000Processor {
	...
	private static String generateMtDNACNCommand(String localFile, String jarFile, ASSAY_TYPE aType, String refGenome,
			String captureBed) {
	...
	private static String generateQsub(String localFile, String jarFile, ASSAY_TYPE aType, String refGenome,
			String captureBed) {
	...
	private static String getDLCommand(String remoteFile, String localFile) {
		...
		cmd = cmd + ASCP_COMMAND_BASE + remoteFile + ".bai" + " " + ext.rootOf(localFile, false) + ".bai";

		return cmd;
	}

	private static void setup(String fileList, String capture, String outDir, String jarFile, String refGenome) {
