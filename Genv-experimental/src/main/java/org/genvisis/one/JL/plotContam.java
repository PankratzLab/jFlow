...
public class plotContam {
  ...
  public static void main(String[] args) {
    ...
    for (String file : files) {
      ...
      String[] sampsToPlot =
          HashVec.loadFileToStringArray("D:/data/Project_Tsai_21_25_26_spector/QC/bamContam/CushingSamps.txt",
      ...
      for (int j = 1; j < samps.length; j++) {
        ...
        if (index >= 0) {
          ...
          RScatter rscScatter =
              new RScatter(withMedian, root + ".rscript", ext.removeDirectoryInfo(root),
                           root + ".jpeg", "PROP_REF_BIN",
                           new String[] {samps[j], "PopulationMedian"}, SCATTER_TYPE.POINT,
                           new Logger());
