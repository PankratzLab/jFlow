...
public class ControlSelectionSimulation {
	...
	private static List<String> selectCases(List<String> all, Hashtable<String, String> pheno, String cent,
			Hashtable<String, String> have, int num, double percent) {
	...
	private static void runit(ArrayList<String> lambdaReport, List<String> casesL, int i, String rootOut, String mds,
			String plinkQc, Hashtable<String, String> hash, HashMap<String, ArrayList<String>> centers, int min,
			ArrayList<String> qqFiles, String cent1, String centComp, ArrayList<String> barns, String pheno, int rep,
			double threshold) {
		...
		run(plinkQc, mds, hash, qqFiles, centComp, matchDir, "optimal", cases, controls, lambdaReport, i, pheno, rep,
				threshold);
		...
		run(plinkQc, mds, hash, qqFiles, centComp, matchDirRandom, "random", cases, ArrayUtils.toStringArray(sub),
				lambdaReport, i, pheno, rep, threshold);
	}
	...
	private static String selectControls(List<String> casesL, String centComp, ArrayList<String> barns, String[] run,
		...
		String matchFileanti = MatchSamples.matchMaker(dir, centComp + ".anchors.txt", centComp + ".barns.txt",
	...
	private static void run(String plinkQc, String mds, Hashtable<String, String> hash, ArrayList<String> qqFiles,
			...
			int i, String pheno, int rep, double threshold) {
	...
	private static void writeReport(String cent, String tag, String[] cases, ArrayList<String> lambdaReport,
			String pheno, int rep, double threshold, String out, boolean hadCovars, double maf) {
		...
		String report = cent + "\t" + tag + "\t" + cases.length + "\t" + rep + "\t" + threshold + "\t"
				+ ArrayUtils.lambda(Doubles.toArray(p)) + "\t" + pheno + "\t" + hadCovars + "\t" + maf;
