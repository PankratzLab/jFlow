...
/**
 * @author lane0212 Mash some google searches together and see how many hits come out...
 */
public class GoogleMash implements Serializable {
  ...
  public void queryAll(int numThreads) {
    ...
    try (WorkerTrain<GQuery> train = new WorkerTrain<>(producer, numThreads, numThreads, log)) {
      int index = 0;
      while (train.hasNext()) {
