...
public class AddBlankSamples {
  ...
  public static void main(String[] args) {
    String vcf =
        "/panfs/roc/groups/5/pankrat2/shared/CHARGE/charge_fibrinogen_mafs_and_counts.xln.hg19_multianno.eff.gatk.sed.vcf";
    ...
    if (!VCFOps.existsWithIndex(outVcf)) {
      ...
      VCFFormatHeaderLine newFormat =
          new VCFFormatHeaderLine("GT", 1, VCFHeaderLineType.String, "A blank genotype");
