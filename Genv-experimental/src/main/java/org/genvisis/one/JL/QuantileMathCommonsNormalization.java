...
public class QuantileMathCommonsNormalization {
	 ...
	 *
	 * @param rawData
	 *            matrix containing expression/methylation data
	 */
	...
	/**
	 * Quantile normalize data where missing values are allowed. the missing values are replaced with the median or mean of the other probes in the sample If chosen keep median value instead of the NA value.
	 *
	 ...
	 *            matrix containing expression/methylation data
	 * @param useMean
	 *            use mean for guessing the NA value if false use median
	 * @param retainNA
	 *            retain the NA values, put NA values back after normalization
	 */
