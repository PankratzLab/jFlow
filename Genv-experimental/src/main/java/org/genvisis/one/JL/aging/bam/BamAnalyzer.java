...
public class BamAnalyzer {
	...
	/**
	 * Analyze the current .bam file. Calls
	 * {@link BamAnalysis#shouldAnalyze(SAMRecord, Logger)} and
	 * {@link BamAnalysis#analyze(SAMRecord, Logger)} on each {@link SAMRecord}
	 * in the file
	 * 
	 * @throws IOException
	 */
	public void analyze() throws IOException {
		...
		for (SAMRecord samRecord : reader) {
			...
			if (num % 1000000 == 0) {
				log.reportTimeInfo("Processing reads for sample " + sample + " , scanned " + num + ", currently on "
