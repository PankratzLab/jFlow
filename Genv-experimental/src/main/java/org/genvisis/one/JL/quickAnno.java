...
public class quickAnno {
  ...
  private static String adjustPositions(String in, int adjust, Logger log) {
    ...
    VariantContextWriter writer =
        VCFOps.initWriterWithHeader(reader, output, VCFOps.DEFUALT_WRITER_OPTIONS, log);
  ...
  public static void main(String[] args) {
    ...
    String anno =
        GATK_Genotyper.annotateOnlyWithDefualtLocations(oneMinus, null, true, false, new Logger());
    adjustPositions(anno, 1, log);
