...
// final TableView<ObservableList<StringProperty>> table = new
// TableView<ObservableList<StringProperty>>();
...
// TableFilter filter =TableFilter.forTableView(table).apply();
//
// } catch (Exception e) {
...
// TableColumn<ObservableList<StringProperty>, String> column = new
...
// column
// .setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ObservableList<StringProperty>,
