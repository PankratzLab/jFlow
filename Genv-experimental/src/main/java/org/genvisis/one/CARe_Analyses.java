...
public class CARe_Analyses {
  ...
  public static final String[] STUDIES =
      new String[] {"ARIC", "CARDIA", "CFS", "CHS", "FHS", "MESA"};
  ...
  public static final String[][] RACES = new String[][] {{"asians", "ASN", "Asian"},
      {"blacks", "AAM", "Black"}, {"hispanics", "HIS", "Hispanic"}, {"whites", "CEU", "White"}};

  public static final String[][] DEMO_NEEDS = {{"FID"}, {"IID"}, {"CAReID"}, {"icam"}, {"ln_icam"},
      {"Age"}, {"Male"}, {"BMI"}, {"Race"}, {"rs5491"}, {"rs5491carrier"}};
  public static final String[][] DEMO_PARAMETERS = {
      ...
      {"# Hispanics with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank"},
      {"mean ICAM levels in Hispanics", "mean", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank"},};

  public static final String[][] COUNT_PARAMETERS = {
      {"# whites", "count", "icam", "Race=White", "-blank"},
      {"# whites with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=White", "-blank"},
      {"# whites / rs5491 carrier", "count", "icam", "icam=ValidDouble", "Race=White", "-blank",
          "rs5491=1"},
      {"# whites / rs5491 non-carrier", "count", "icam", "icam=ValidDouble", "Race=White", "-blank",
          "rs5491=0"},
      {"# whites / carrier status unknown", "count", "icam", "icam=ValidDouble", "Race=White",
          "-blank", "rs5491=."},

      {"# blacks", "count", "icam", "Race=Black", "-blank"},
      {"# blacks with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Black", "-blank"},
      {"# blacks / rs5491 carrier", "count", "icam", "icam=ValidDouble", "Race=Black", "-blank",
          "rs5491=1"},
      {"# blacks / rs5491 non-carrier", "count", "icam", "icam=ValidDouble", "Race=Black", "-blank",
          "rs5491=0"},
      {"# blacks / carrier status unknown", "count", "icam", "icam=ValidDouble", "Race=Black",
          "-blank", "rs5491=."},

      {"# Asians", "count", "icam", "Race=Asian", "-blank"},
      {"# Asians with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Asian", "-blank"},
      {"# Asians / rs5491 carrier", "count", "icam", "icam=ValidDouble", "Race=Asian", "-blank",
          "rs5491=1"},
      {"# Asians / rs5491 non-carrier", "count", "icam", "icam=ValidDouble", "Race=Asian", "-blank",
          "rs5491=0"},
      {"# Asians / carrier status unknown", "count", "icam", "icam=ValidDouble", "Race=Asian",
          "-blank", "rs5491=."},

      {"# Hispanics", "count", "icam", "Race=Hispanic", "-blank"},
      {"# Hispanics with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank"},
      {"# Hispanics / rs5491 carrier", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank", "rs5491=1"},
      {"# Hispanics / rs5491 non-carrier", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank", "rs5491=0"},
      {"# Hispanics / carrier status unknown", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank", "rs5491=."},};

  public static final String[][] LEVEL_PARAMETERS = {
      {"mean ICAM levels in whites / rs5491 carrier", "mean", "icam", "icam=ValidDouble",
          "Race=White", "-blank", "rs5491=1"},
      {"mean ICAM levels in whites / rs5491 non-carrier", "mean", "icam", "icam=ValidDouble",
          "Race=White", "-blank", "rs5491=0"},
      {"mean ICAM levels in whites / carrier status unknown", "mean", "icam", "icam=ValidDouble",
          "Race=White", "-blank", "rs5491=."},

      {"mean ICAM levels in blacks / rs5491 carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Black", "-blank", "rs5491=1"},
      {"mean ICAM levels in blacks / rs5491 non-carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Black", "-blank", "rs5491=0"},
      {"mean ICAM levels in blacks / carrier status unknown", "mean", "icam", "icam=ValidDouble",
          "Race=Black", "-blank", "rs5491=."},

      {"mean ICAM levels in Asians / rs5491 carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Asian", "-blank", "rs5491=1"},
      {"mean ICAM levels in Asians / rs5491 non-carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Asian", "-blank", "rs5491=0"},
      {"mean ICAM levels in Asians / carrier status unknown", "mean", "icam", "icam=ValidDouble",
          "Race=Asian", "-blank", "rs5491=."},

      {"mean ICAM levels in Hispanics / rs5491 carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Hispanic", "-blank", "rs5491=1"},
      {"mean ICAM levels in Hispanics / rs5491 non-carrier", "mean", "icam", "icam=ValidDouble",
          "Race=Hispanic", "-blank", "rs5491=0"},
      {"mean ICAM levels in Hispanics / carrier status unknown", "mean", "icam", "icam=ValidDouble",
  ...
  public static final String[][] FINAL_PARAMETERS = {
      ...
      {"mean ICAM levels in whites", "mean", "icam", "icam=ValidDouble", "Race=White", "-blank",
          "sf=2", "rs5491=0", "-stdev"},
      {"mean age in whites", "mean", "Age", "icam=ValidDouble", "Race=White", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"% male in whites", "mean", "Male", "icam=ValidDouble", "Race=White", "-blank", "sf=2",
          "rs5491=0", "-percent"},
      {"mean BMI in whites", "mean", "BMI", "icam=ValidDouble", "Race=White", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"# blacks with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Black", "-blank",
          "rs5491=0"},
      {"mean ICAM levels in blacks", "mean", "icam", "icam=ValidDouble", "Race=Black", "-blank",
          "sf=2", "rs5491=0", "-stdev"},
      {"mean age in blacks", "mean", "Age", "icam=ValidDouble", "Race=Black", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"% male in blacks", "mean", "Male", "icam=ValidDouble", "Race=Black", "-blank", "sf=2",
          "rs5491=0", "-percent"},
      {"mean BMI in blacks", "mean", "BMI", "icam=ValidDouble", "Race=Black", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"# Asians with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Asian", "-blank",
          "rs5491=0"},
      {"mean ICAM levels in Asians", "mean", "icam", "icam=ValidDouble", "Race=Asian", "-blank",
          "sf=2", "rs5491=0", "-stdev"},
      {"mean age in Asians", "mean", "Age", "icam=ValidDouble", "Race=Asian", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"% male in Asians", "mean", "Male", "icam=ValidDouble", "Race=Asian", "-blank", "sf=2",
          "rs5491=0", "-percent"},
      {"mean BMI in Asians", "mean", "BMI", "icam=ValidDouble", "Race=Asian", "-blank", "sf=2",
          "rs5491=0", "-stdev"},
      {"# Hispanics with ICAM levels", "count", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank", "rs5491=0"},
      {"mean ICAM levels in Hispanics", "mean", "icam", "icam=ValidDouble", "Race=Hispanic",
          "-blank", "sf=2", "rs5491=0", "-stdev"},
      {"mean age in Hispanics", "mean", "Age", "icam=ValidDouble", "Race=Hispanic", "-blank",
          "sf=2", "rs5491=0", "-stdev"},
      {"% male in Hispanics", "mean", "Male", "icam=ValidDouble", "Race=Hispanic", "-blank", "sf=2",
          "rs5491=0", "-percent"},
      {"mean BMI in Hispanics", "mean", "BMI", "icam=ValidDouble", "Race=Hispanic", "-blank",
          "sf=2", "rs5491=0", "-stdev"},};

  public static final String[][] FINAL2_PARAMETERS = {
      {"# with genotypes and ICAM levels", "count", "icam", "icam=ValidDouble", "BMI=ValidDouble",
          "-blank"},
      {"mean ICAM levels", "mean", "icam", "icam=ValidDouble", "BMI=ValidDouble", "-blank", "sf=2",
          "-stdev"},
      {"mean age", "mean", "Age", "icam=ValidDouble", "BMI=ValidDouble", "-blank", "sf=2",
          "-stdev"},
      {"% male", "mean", "Male", "icam=ValidDouble", "BMI=ValidDouble", "-blank", "sf=2",
          "-percent"},
      {"mean BMI", "mean", "BMI", "icam=ValidDouble", "BMI=ValidDouble", "-blank", "sf=2",
          "-stdev"},};
  ...
  public static void analyzeGenotypedVariants(String phenoFile, int chr, int start, int stop,
      ...
      for (String[] element2 : RACES) {
        ...
        if (new File(dir + phenoFile).exists()) {
          ...
          CmdLine.run("plink --noweb --bfile " + DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + element
              + "/pheno/full --chr " + chr + " --from-kb " + (int) Math.floor(start / 1000.0)
              + " --to-kb " + (int) Math.ceil(stop / 1000.0) + " --linear --ci 0.95 --pheno "
              + phenoFile + " --covar " + phenoFile
          ...
          CmdLine.run("plink --noweb --bfile " + DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + element
              ...
              + DRIVE_ROOT + "Analyses/" + subDirectory + element2[0] + "_" + element, dir);
          CmdLine.run("plink --noweb --bfile " + DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + element
              + "/pheno/full --snps " + variantID + " --linear --pheno plink_pheno.dat --out "
              + DRIVE_ROOT + "Analyses/" + subDirectory + element2[0] + "_" + element + "noCovar",
              dir);
        }
      }
    }
    ...
    for (String element : STUDIES) {
      for (String[] element2 : RACES) {
        ...
        if (new File(dir + "plink_pheno.dat").exists()) {
          ...
          CmdLine.run("plink --noweb --bfile " + DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + element
              + "/pheno/full --chr " + chr + " --from-kb " + (int) Math.floor(start / 1000.0)
              + " --to-kb " + (int) Math.ceil(stop / 1000.0) + " --freq --out " + DRIVE_ROOT
              + "Analyses/" + subDirectory + element2[0] + "_" + element, dir);
          Metal.convertPlinkResults(DRIVE_ROOT + "Analyses/ICAM/",
              ...
              DRIVE_ROOT + "Analyses/" + subDirectory + element2[0] + "_" + element + ".se.metal",
              false);
    ...
    Files.combine(
        HashVec.loadFileToStringArray(DRIVE_ROOT + "Analyses/" + subDirectory + "allSNPs.txt", true,
            new int[] {0}, false),
    ...
    leaders = new String[] {"whites_ARIC", "whites_CARDIA", "whites_CFS", "whites_CHS",
        "whites_FHS", "whites_MESA", "blacks_CARDIA", "blacks_CHS", "blacks_CFS", "blacks_MESA",
    ...
    for (String leader : leaders) {
      ...
      if (new File(dir + "_SE1.out").exists()) {
        try {
            ...
            if (hash.contains(line[0])) {
              try {
                writer = new PrintWriter(
                    new FileWriter(DRIVE_ROOT + "Analyses/ICAM/" + line[0] + ".txt", true));
          ...
          System.err
              .println("Error reading file \"" + dir + "plink_pheno_iteration1.InvVar1.out" + "\"");
          System.exit(2);
        }
      }
                ...
                if (new File(DRIVE_ROOT + "Analyses/ICAM/" + line[0] + ".txt").length() == 0) {
                  ...
                  try {
                    PrintWriter writer2 = new PrintWriter(
                        new FileWriter(DRIVE_ROOT + "Analyses/ICAM/" + line[0] + ".R"));
                    ...
                    writer2.println(
                        "logeffect=F, boxsize=0.4,logticks=T, col=meta.colors(\"black\"),");
                    writer2.println("xlab=\"" + line[0] + " beta\", ylab=\"Cohort\")");
                    writer2.close();
                  } catch (Exception e) {
                    System.err.println(
                        "Error writing to " + DRIVE_ROOT + "Analyses/ICAM/" + line[0] + ".R");
                    e.printStackTrace();
                  }
        ...
        if (FAMILY_BASED[i]) {
          ...
          if (new File(dir + phenofile).exists()) {
            ...
            if (!Files.exists(dir + "rids_" + root + ".fhsR", false)) {
              hash = HashVec.loadFileToHashString(
                  dir + "leslie_lange." + STUDIES[i] + ".IBC." + element[1] + ".Rlinker",
                  new int[] {0}, new int[] {2}, false, "", false, false, false);
              hash.put("id", "id");
              try {
                ...
                System.err.println(
                    "Error: file \"" + dir + root + ".fhsR" + "\" not found in current directory");
                System.exit(1);
              } catch (IOException ioe) {
            ...
            GWAF.batch(dir + "analysis_of_" + pheno + "/", "../" + phenofile, pheno, covars, "a",
                ...
                root + (numExtraCovars > 0 ? "_withCondi" + numExtraCovars : "") + "_out.csv", root,
                null, 1, 1);
            new File(dir + "analysis_of_" + pheno + "/" + root + ".R").renameTo(
                new File(dir + "analysis_of_" + pheno + "/" + root + numExtraCovars + ".R"));
            new File(dir + "analysis_of_" + pheno + "/run" + numExtraCovars + "." + pheno + ".bat")
                .delete();
            new File(dir + "analysis_of_" + pheno + "/run." + pheno).renameTo(new File(
                dir + "analysis_of_" + pheno + "/run" + numExtraCovars + "." + pheno + ".bat"));
            new File(
                dir + root + (numExtraCovars > 0 ? "_withCondi" + numExtraCovars : "") + "_out.csv")
                    .delete();
          ...
          if (new File(dir + phenofile).exists()) {
            ...
            if (!Files.exists(dir + root + ".map", false)) {
              Files.combine(
                  HashVec.loadFileToStringArray(dir + root + ".pinfo", true, new int[] {0}, false),
                  new String[] {
                      DRIVE_ROOT + "CARe_imputed_all_llange_24mar2010/allSNPs.map 0 1 0 $#0 2"},
            ...
            commands = "/home/npankrat/bin/plink --noweb --fam ../" + "leslie_lange." + STUDIES[i]
                ...
                + phenofile + " --covar-name " + Array.toStr(covars, ",") + " " + "--out " + root
                + (numExtraCovars > 0 ? "_withCondi" + numExtraCovars : "") + "_out";
  ...
  public static void batch(int numBatches) {
    ...
    try {
      ...
      while (new File(dir + "gwaf/file" + count + ".fhsR").exists()) {
        writers[count % numBatches]
            .println("lme.batch.imputed(\"pheno.csv\", \"file" + count + ".fhsR.gz\", \""
                + ext.rootOf(root) + ".pedfile\", \"pheno\", \"kmat.Rfile\", covars=NULL, \"results"
                + count + ".csv\", col.names=T, sep.ped=\",\", sep.phe=\",\", sep.gen=\",\")");
        count++;
      }
      for (int i = 1; i <= numBatches; i++) {
        writers[i - 1].close();
  ...
  public static void catAllDBs() {
    ...
    for (String[] element : RACES) {
      for (String element2 : STUDIES) {
        filename =
            DRIVE_ROOT + "/Analyses/ICAM/IBC/" + element[0] + "/" + element2 + "/pheno/db.txt";
  ...
  public static void catAllPhenos() {
    ...
    skips[0] = 0;
    Files.cat(Array.toStringArray(v),
        "D:/CARe/Analyses/ICAM/IBC/analysis_of_ln_icam_InverseNormalized/allPhenos.dat", skips,
        new Logger());
  }
  ...
  public static void generate_ABO_ICAM_covariates() {
    ...
    Files.writeList(new String[] {"rs5498", "rs1799969", "rs651007"},
        ...
        if (new File(dir + "abo_icam.dosage").exists()) {
          ...
          hitlist =
              new String[] {"lookup",
                  ...
                  "abo_icam.dosage.csv , 0 " + Array.toStr(Array.stringArraySequence(
                      new SnpMarkerSet(dir + "abo_icam.dosage.pinfo").getMarkerNames().length, ""),
                      " "),
          ...
          if (STUDIES[i].equals("MESA")
            ...
            hitlist = Array.addStrToArray(DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + STUDIES[i]
                + "/pheno/" + element[3] + "QC/rs1799969.xln 1 4=rs1799969c", hitlist, 5);
          }
          ...
          CmdLine.run("java -cp C:/home/npankrat/" + org.genvisis.common.PSF.Java.GENVISIS
              + " -Xmx1024M Launch -suppress generatePhenoForPlinkWithConditionals.crf", dir);
          if (FAMILY_BASED[i]) {
            Files.writeList(
                new String[] {"lookup",
            ...
            CmdLine.run("java -cp C:/home/npankrat/" + org.genvisis.common.PSF.Java.GENVISIS
                + " -Xmx1024M Launch -suppress generatePhenoForGWAFWithConditionals.crf", dir);
            new File("D:/upload/phenos/" + STUDIES[i] + "_" + element[0] + "/").mkdirs();
            Files.copyFile(dir + "phenoWithConditionals.csv",
                "D:/upload/phenos/" + STUDIES[i] + "_" + element[0] + "/phenoWithConditionals.csv");
          } else {
            new File("D:/upload/phenos/" + STUDIES[i] + "_" + element[0] + "/").mkdirs();
            Files.copyFile(dir + "plink_phenoWithConditionals.dat", "D:/upload/phenos/" + STUDIES[i]
                + "_" + element[0] + "/plink_phenoWithConditionals.dat");
          }
        }
      }
    }
        ...
        if (new File(root + ".gen").exists()) {
          ...
          if (FAMILY_BASED[i]) {
            new DosageData(finalDir + "abo_icam.dosage", finalDir + "abo_icam.ids.fam",
                finalDir + "abo_icam.pinfo", true, log).writeToFile(finalDir + "abo_icam.fhsR",
                    finalDir + "abo_icam.mlinfo", null, null, DosageData.GWAF_FORMAT, log);
          }
        }
      }
    }
    ...
    for (String element : STUDIES) {
      for (String[] element2 : RACES) {
        ...
        if (new File(dir + "abo_icam.dosage").exists()) {
          new DosageData(dir + "abo_icam.dosage", dir + "abo_icam.ids.fam", dir + "abo_icam.pinfo",
              true, log).writeToFile(dir + "abo_icam.mldose", dir + "abo_icam.mlinfo", null, null,
                  DosageData.MACH_MLDOSE_FORMAT, log);
        }
      }
    }
            ...
            if (hash.contains(line[0])) {
              try {
                ...
                writer.println((dir.equals("") ? "Joint_analysis"
                    : ext.replaceAllWith(dir, "/", "_").substring(0, dir.length() - 1)) + "\t"
                    + line[0] + "\t" + line[1].toUpperCase() + "\t" + line[2].toUpperCase() + "\t"
                    + line[3] + "\t" + line[4]);
                writer.close();
              } catch (Exception e) {
                System.err.println("Error writing to something");
  ...
  public static void gwafBatches(String phenofile, String pheno, boolean conditionals) {
    ...
    try {
      writer = new PrintWriter(new FileWriter(
          "batchAllGWAF." + ext.rootOf(phenofile) + (conditionals ? "_withCondi" : "")));
      for (String element : STUDIES) {
        for (String[] element2 : RACES) {
          dir = element + "_" + element2[0] + "/";
          if (new File(dir + phenofile).exists()) {
            commands = Files.getRunString() + " gwas.GWAF " + "phenoFile=" + phenofile + " "
                + "pheno=" + pheno + " " + "genoPrimer=gwaf/file#.fhsR.gz " + "outfileTemplate="
                + ext.rootOf(phenofile) + (conditionals ? "_withCondi" : "") + "_results#.csv "
                + "qsubRoot=batches/" + ext.rootOf(phenofile) + (conditionals ? "_withCondi" : "")
                + "_file#.qsub " + "startAt=0 " + "imputed=true " + "pedfile=pedfile.csv "
  ...
  public static void justConvert(int startAt) {
    ...
    while (Files.exists(dir + "std/file" + fileNum + ".gen", false)) {
      new DosageData(dir + "std/file" + fileNum + ".gen", dir + "std/ids.pfam",
          dir + "std/file" + fileNum + ".mlinfo", true, log).writeToFile(
              dir + "gwaf/file" + fileNum + ".fhsR", dir + "gwaf/file" + fileNum + ".pmap", null,
      ...
      for (String[] element : RACES) {
        ...
        for (int j = 0; j < STUDIES.length; j++) {
          dir = DRIVE_ROOT + "Analyses/ICAM/IBC/" + element[0] + "/" + STUDIES[j] + "/analysis_of_"
              + pheno + "/";
          // System.err.println(dir);
          if (FAMILY_BASED[j] && Files
              .exists(dir + root + (iter > 0 ? "_withCondi" + iter : "") + "_out.csv", false)) {
            ...
            GWAF.parseToMetal(dir + root + "_iteration" + iter + ".csv",
                dir + "../" + root + ".pinfo", null, finalDir + "iteration" + iter + "/"
                    + element[0] + "_" + STUDIES[j] + "_iteration" + iter + ".metal",
                false, false, false);
            files.add(element[0] + "_" + STUDIES[j] + "_iteration" + iter + ".metal");
            allFiles.add(element[0] + "_" + STUDIES[j] + "_iteration" + iter + ".metal");
          } else if (Files.exists(
              dir + root + (iter > 0 ? "_withCondi" + iter : "") + "_out.assoc.dosage", false)) {
            GenParser.parse(new String[] {
                dir + root + (iter > 0 ? "_withCondi" + iter : "") + "_out.assoc.dosage",
                "out=" + finalDir + "iteration" + iter + "/" + element[0] + "_" + STUDIES[j]
                    + "_iteration" + iter + ".metal",
                "'SNP'=MarkerName", "'A1'=Allele1", "'A2'=Allele2", "'BETA'=Effect", "'SE'=StdErr",
                "'P'=P-value"}, log);
            files.add(element[0] + "_" + STUDIES[j] + "_iteration" + iter + ".metal");
            allFiles.add(element[0] + "_" + STUDIES[j] + "_iteration" + iter + ".metal");
          } else {
            System.out
                .println("Did not find either " + dir + root + (iter > 0 ? "_withCondi" + iter : "")
                    + "_out.csv OR " + dir + root + "_withCondi1_out.assoc.dosage");
          }
          try {
            Thread.sleep(1000);
      ...
      for (String[] element : RACES) {
        ...
        if (new File(dir + "pheno/db.txt").exists()) {
          GenParser.parse(new String[] {dir + "pheno/db.txt", "0", "1", "2", "4", "8", "!4!.",
              "!9=0", "!8=" + element[2], "out=" + dir + "pheno/db_" + element[0] + ".txt"}, log);
          ...
          Transformations.transformFile(dir + "pheno/db_" + element[0] + ".txt",
              dir + "pheno/db_" + element[0] + "_normalized.txt", true, 3, false, false,
              Transformations.NORMALIZE, log);
          Transformations.transformFile(dir + "pheno/db_" + element[0] + ".txt",
              dir + "pheno/db_" + element[0] + "_inverseNormalized.txt", true, 3, false, false,
              Transformations.INVERSE_NORMALIZE, log);
          ...
          if (new File(dir + "abo_icam.dosage").exists()) {
            ...
            new DosageData(dir + "abo_icam.dosage", dir + "abo_icam.ids.fam",
                ...
                DRIVE_ROOT + "Analyses/ICAM/covarSNPs.txt", true, log).writeToFile(
                    dir + "abo_icam.dosage.csv", dir + "abo_icam.dosage.pinfo", null, null, true,
                    true, DosageData.PARAMETERS[DosageData.GWAF_FORMAT], log);
            ...
            if (STUDIES[i].equals("MESA")
                && (element[0].equals("asians") || element[0].equals("hispanics"))) {
              hitlist = Array.addStrToArray(DRIVE_ROOT + "Analyses/ICAM/IBC/whites/" + STUDIES[i]
                  + "/pheno/" + element[3] + "QC/rs1799969.xln 1 4=rs1799969c", hitlist, 6);
            }
            Files.writeList(hitlist, dir + "generateNormalizedPhenoForPlinkWithConditionals.crf");
            CmdLine.run(
                "java -cp C:/home/npankrat/" + org.genvisis.common.PSF.Java.GENVISIS
            ...
            if (FAMILY_BASED[i]) {
              Files.writeList(
                  new String[] {"lookup",
                      ...
                      "leslie_lange." + STUDIES[i] + ".IBC." + element[1]
                          + ".Rlinker 0 2=id skip=0",
              ...
              CmdLine.run(
                  ...
                  dir);
              new File("D:/upload/phenos/" + STUDIES[i] + "_" + element[0] + "/").mkdirs();
              Files.copyFile(dir + "normalizedPhenoWithConditionals.csv", "D:/upload/phenos/"
                  + STUDIES[i] + "_" + element[0] + "/normalizedPhenoWithConditionals.csv");
              Files.copyFile(dir + "inverseNormalizedPhenoWithConditionals.csv", "D:/upload/phenos/"
                  + STUDIES[i] + "_" + element[0] + "/inverseNormalizedPhenoWithConditionals.csv");
            } else {
              new File("D:/upload/phenos/" + STUDIES[i] + "_" + element[0] + "/").mkdirs();
              Files.copyFile(dir + "plink_normalizedPheno.dat", "D:/upload/phenos/" + STUDIES[i]
                  + "_" + element[0] + "/plink_normalizedPheno.dat");
              Files.copyFile(dir + "plink_inverseNormalizedPheno.dat", "D:/upload/phenos/"
                  + STUDIES[i] + "_" + element[0] + "/plink_inverseNormalizedPheno.dat");
            }
          }
    ...
    for (String[] element : RACES) {
      ...
      for (String element2 : STUDIES) {
        ...
        if (new File(dir + "abo_icam.dosage").exists()) {
          ...
          Files
              .writeList(
                  new String[] {"lookup", "abo_icam.ids.fam 1 hideIndex out=demographics.dat",
                      "abo_icam.ids.fam 1 0=FID 1=IID skip=0",
        ...
        Files.generateTables(DRIVE_ROOT + "Analyses/ICAM/" + element[0] + "_demographics.xln",
            Array.toStringArray(files), Array.toStringArray(fileDescriptions), FINAL2_PARAMETERS,
            log);
      }
  ...
  public static void parseMapAndFreqFiles() {
    ...
    for (String[] element : RACES) {
      ...
      for (String studie : studies) {
        ...
        if (new File(dir + root + ".bim").exists()) {
          ...
          parameters.add(DRIVE_ROOT + "CARe_geno_data_and_misc/IBC/alleleFreqs/" + element[0] + "_"
              + studie + ".frq 1 2=" + studie + "_" + element[0] + "_A1 3=" + studie + "_"
              + element[0] + "_A2 4=" + studie + "_" + element[0] + "_freq 5=" + studie + "_"
              + element[0] + "_N $#1=" + studie + "_" + element[0] + "_Rsq");
      ...
      Files.combine(
          HashVec.loadFileToStringArray(DRIVE_ROOT + "CARe_geno_data_and_misc/IBC/allSNPs.txt",
              true, new int[] {0}, false),
          Array.toStringArray(parameters), null, "MarkerName", ".",
          DRIVE_ROOT + "CARe_geno_data_and_misc/IBC/alleleFreqs/" + element[0] + "_freq_input.txt",
          log, true, true, false);
      Metal.calculateWeightedAlleleFrequency(
          DRIVE_ROOT + "CARe_geno_data_and_misc/IBC/alleleFreqs/" + element[0] + "_freq_input.txt",
          0.30, -1, log);
    }
    ...
    for (String[] element : RACES) {
      ...
      Files.combine(
          HashVec.loadFileToStringArray(
              DRIVE_ROOT + "CARe_imputed_all_llange_24mar2010/allSNPs.txt", true, new int[] {0},
              false),
          Array.toStringArray(files), null, "MarkerName", ".",
          DRIVE_ROOT + "CARe_imputed_all_llange_24mar2010/" + element[0] + "_freq_input.txt", log,
          true, true, false);
      Metal.calculateWeightedAlleleFrequency(
          DRIVE_ROOT + "CARe_imputed_all_llange_24mar2010/" + element[0] + "_freq_input.txt", 0.30,
          -1, log);
    }
    keys = HashVec.getKeys(positions);
    map = new String[keys.length];
    ...
    for (String studie : studies) {
      for (String[] element : RACES) {
        ...
        if (new File(dir + filename).exists()) {
          GenParser.parse(
              new String[] {dir + filename, "out=" + dir + studie + "_" + element[0] + ".freq",
                  "1=MarkerName", "3=A1", "4=A2", "5=Freq", "6=Rsq", "!6>0.30"},
              log);
        }
        ...
        if (new File(dir + filename).exists()) {
          Files.combine(
              HashVec.loadFileToStringArray(dir + studie + "_" + element[0] + "_snps.txt", true,
                  new int[] {0}, false),
              new String[] {dir + studie + "_" + element[0] + ".mlinfo 0 1=A1 2=A2 3=Freq 6=Rsq"},
              null, "MarkerName", ".", dir + studie + "_" + element[0] + ".freq", log, false, true,
              false);
        }
      }
    }
      ...
      for (String[] element2 : RACES) {
        ...
        if (new File(dir + filename).exists()) {
          GenParser.parse(new String[] {dir + filename,
              "out=" + dir + (label == null ? "" : label + "_") + element + "_" + element2[0]
                  + ".input",
              "1=MarkerName", "3=A1", "4=A2", "!6>0.30", "7=beta", "8=StdErr", "!7<5", "!7>-5",
              "!8!NA", "!8!0"}, log);
          count++;
        }
        ...
        filename =
            (label == null ? "" : label + "_") + element + "_" + element2[0] + "_results.csv";
        if (new File(dir + filename).exists()) {
          ...
          Files.combine(
              HashVec.loadFileToStringArray(
                  dir + element.toLowerCase() + "_" + element2[0].toLowerCase() + "_snps.txt", true,
                  new int[] {0},
                  false),
              new String[] {dir + element.toLowerCase() + "_" + element2[0].toLowerCase()
                  + ".mlinfo 0 1=A1 2=A2", dir + filename + " , 0 1=beta;. 2=StdErr;. fail"},
              null, "MarkerName", ".",
              dir + (label == null ? "" : label + "_") + element + "_" + element2[0] + ".input",
        ...
        for (String[] element2 : RACES) {
          ...
          if (new File(dir + phenofile).exists()) {
            commands = "/home/npankrat/bin/plink --noweb --fam leslie_lange." + element + ".IBC."
                ...
                + element2[1] + ".chr#.pmap " + "--dosage 00src/leslie_lange." + element + ".IBC."
                + element2[1] + ".chr#.gen.gz Zin skip0=1 skip1=1 skip2=0 format=3 noheader "
                + "--pheno " + phenofile + " --pheno-name " + pheno + " " + "--covar " + phenofile
                + " --covar-name Age,Male,BMI"
                + (conditionals ? ",rs5498,rs651007" + (element.equals("MESA")
                    && (element2[0].equals("asians") || element2[0].equals("hispanics")) ? ""
                        : ",rs1799969")
                    : "")
                + ",EV1,EV2,EV3,EV4,EV5,EV6,EV7,EV8,EV9,EV10 " +
            ...
            Files.writeList(
                Files.qsub(dir, "chr#_" + element, 1, 22, commands, null, 10000, 12, null),
                dir + "master." + pheno);
    ...
    try {
      ...
      for (int chr = 1; chr <= 22; chr++) {
        try {
          ...
          System.err.println(
              "Error: file \"" + dir + root + chr + ".gen" + "\" not found in current directory");
          System.exit(1);
        } catch (IOException ioe) {
          System.err
  ...
  public static void upToDate(String phenofile, String pheno, boolean conditionals) {
    ...
    try {
      writer = new PrintWriter(
          new FileWriter("catchUp." + ext.rootOf(phenofile) + (conditionals ? "_withCondi" : "")));
      ...
      System.out.println("Files remaining: "
          + (v.size() == 0 ? "none" : ext.listRanges(Array.toIntArray(Array.toStringArray(v)))));
    } catch (Exception e) {
      ...
      for (int chr = 1; chr <= 22; chr++) {
        ...
        try {
          ...
          ext.checkHeader(header,
              new String[] {"SNP", "Al1", "Al2", "Freq1", "MAF", "Quality", "Rsq"}, true);
          count = 0;
          while (reader.ready()) {
            count++;
            ...
            if (line.length != 4) {
              log.reportError(
                  "Error at record marker '" + marker + "' on line " + count + " in file " + root
                      + chr + ".pmap; expecting " + 4 + " columns, but found " + line.length);
            }
            ...
            if (line.length != 7) {
              log.reportError(
                  "Error at record marker '" + marker + "' on line " + count + " in file " + root
                      + chr + ".mlinfo; expecting " + 7 + " columns, but found " + line.length);
            }
