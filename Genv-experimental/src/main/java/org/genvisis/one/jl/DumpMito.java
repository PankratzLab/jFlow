...
//		int[][] indices = markerSet.getIndicesByChr();
		String[] mitoCurrent = HashVec.loadFileToStringArray("/Users/Kitty/git/affySnp6/MT.119.txt"	, false, new int[]{0}, true);
		int[] indicesM =ext.indexLargeFactors(mitoCurrent, markerSet.getMarkerNames(), true, new Logger(), true, true);
