...
public class ThousandGenomeVariation {
  ...
  public static final String[] HEADER = {"chr", "loc", "ref", "alleles", "snp.Q", "av.max.map.Q",
                                         "depth.cov", "NA12891", "NA12891.Q", "NA12892",
                                         "NA12892.Q", "NA12878", "NA12878.Q", "hwe", "maf", "tdt",
                                         "display"};
  ...
  public static void countVariationInEach(String dir, String[] bedfiles) {
    ...
    for (String bedfile : bedfiles) {
      try {
        reader = new BufferedReader(new FileReader(dir + bedfile));
        reader.readLine();
        counts = new int[3];
        while (reader.ready()) {
        ...
        System.err.println("Error reading file \"" + dir + bedfile + "\"");
        System.exit(2);
      }
