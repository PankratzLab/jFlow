...
public class CARDIAResultsProcessor {
  ...
  static final String HEADER =
      "Markername,Chr,Pos,N,Effect_allele,Other_allele,EAF,Imp_info,Beta,SE,Pvalue";
    ...
    for (int i = 1; i < 23; i++) {
      ...
      try {
        ...
        BufferedReader readerP =
            Files.getAppropriateReader(posDir + POS_TEMPLATE.replace("#", "" + i));
        PrintWriter writer =
            Files.getAppropriateWriter(regDir + OUTFILE_TEMPLATE.replace("#", "" + i));
