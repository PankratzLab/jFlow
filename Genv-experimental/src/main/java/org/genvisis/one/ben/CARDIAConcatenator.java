...
public class CARDIAConcatenator {
  ...
  String fileDir1 = ext.verifyDirFormat(
      "/home/pankarne/pankratz/CARDIA/CARDIA.whites.1000G.imputed/imputed/consent_level_1/");

  String fileDir2 = ext.verifyDirFormat(
      "/home/pankarne/pankratz/CARDIA/CARDIA.whites.1000G.imputed/imputed/consent_level_2/");

  String outDir = ext.verifyDirFormat(
      "/home/pankarne/pankratz/CARDIA/CARDIA.whites.1000G.imputed/imputed/consent_level_all/");
  ...
  private String combineLine(String line1, String line2) throws RuntimeException {
    ...
    if (!line1Parts[0].trim().equals(line2Parts[0].trim())) {
      throw new RuntimeException(
          "Error - mismatched marker names: <" + line1Parts[0] + "> and <" + line2Parts[0] + ">");
    }
    if (!line1Parts[1].trim().equalsIgnoreCase(line2Parts[1].trim())) {
      throw new RuntimeException(
          "Error - mismatched allele 1: <" + line1Parts[1] + "> and <" + line2Parts[1] + ">");
    }
    if (!line1Parts[2].trim().equalsIgnoreCase(line2Parts[2].trim())) {
      throw new RuntimeException(
          "Error - mismatched allele 2: <" + line1Parts[2] + "> and <" + line2Parts[2] + ">");
    }
    ...
    for (String formatTemplate : fileFormats) {
      for (int chrInd = 1; chrInd < 23; chrInd++) {
        ...
        try {
          ...
          PrintWriter writerIDs =
              Files.getAppropriateWriter(outDir + fileIDs.replace("#", chrInd + ""));
          ...
          if (line1 != null) {
            PrintWriter excess1 =
                Files.getAppropriateWriter(outDir + "chr" + chrInd + "_excess_c1.out");
          ...
          if (line2 != null) {
            PrintWriter excess2 =
                Files.getAppropriateWriter(outDir + "chr" + chrInd + "_excess_c2.out");
