...
public class SNPVCFTesting {
  ...
  static String hdr1 =
      "##INFO=<ID=RSMRG,Number=1,Type=String,Description=\"RS number merged with this one\">";
  ...
  static void createTBI() {
    ...
    VariantContextWriter vcw2 =
        VCFOps.initWriter(mergedOut2, VCFOps.DEFUALT_WRITER_OPTIONS, samSequenceDictionary);
