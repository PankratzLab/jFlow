...
public class SNPVCFTesting {
	...
	static String UNIX_numberedVCFFile2 =
																			"/scratch.global/coleb/DBSNP/All_20150605_noRS_rerun.vcf.gz";
	...
	static String[] header = new String[] {	"##fileformat=VCFv4.0", "##fileDate=20150605",
																					"##source=dbSNP", "##dbSNP_BUILD_ID=144",
																					"##reference=GRCh37.p13", "##phasing=partial",
	...
	static void createTBI() {
		...
		VariantContextWriter vcw2 = VCFOps.initWriter(mergedOut2, VCFOps.DEFUALT_WRITER_OPTIONS,
																									samSequenceDictionary);
		...
		while ((line = reader.readLine()) != null) {
			...
			for (String str : infoParts) {
				if (validTags.contains(str)
						|| (str.split("=").length > 1 && validTags.contains(str.split("=")[0]))) {
	...
	static String[] testMarkers = new String[] {"rs12175489", "rs9469003", "rs7080373", "rs2524279",
																							"rs2247296", "rs1503859", "rs5911809", "rs1470383",
																							"rs13427710", "rs6735220", "rs2965174", "rs609418",
																							"rs4465523", "rs13379232", "rs6994361", "rs1413710",
																							"rs4934434", "rs933150", "rs10158752", "rs9803750",
																							"rs4660123", "rs4372063", "rs1641661", "rs754118",
																							"rs6020624",};
