...
public class LiftOverProcessing {
  ...
  private static final String[] DB_LOCS = {"/home/pankrat2/public/bin/ref/hg18ToHg19.over.chain",};
  ...
  protected static void prepPlinkFiles(String plinkDirAndRoot, int conversion,
    ...
    (new File(PSF.Plink.getBIM(plinkDirAndRoot
                               + NEWFILES_APPEND))).renameTo(new File(plinkDirAndRoot
                                                                      + NEWFILES_APPEND
                                                                      + TEMP_BIM));
  ...
  public static void main(String[] args) {
    ...
    for (String arg : args) {
      if (arg.equals("-h") || arg.equals("-help") || arg.equals("/h") || arg.equals("/help")) {
        ...
        numArgs--;
      } else if (arg.startsWith("deleteTemp=")) {
        deleteTemp = ext.parseBooleanArg(arg);
        numArgs--;
      } else {
