 ...
 * http://hollenbachlab.ucsf.edu/ping
 */
public class Ping {
  ...
  private static final class ConvProducer implements Producer<Boolean> {
    ...
    private static boolean convertToFasta(String inputBam, String samToFastQLoc, String r1,
                                          String r2, Logger log) {
  ...
  private static void convertBams(String bamDir, String samToFastQLoc, String outDir,
  ...
  private static void runPING(String bamDir, String samToFastQLoc, String pingLoc, String outDir,
                              int numthreads) {
    ...
    try {
      ...
      String pingScript = PING_SCRIPT.replaceAll(CWD, getPingLoc(outDir))
                                     .replaceAll(SAMP_LOC, getFastQLoc(outDir))
                                     .replaceAll(OUT_DIR, outDir + "results/")
  ...
  public static void main(String[] args) {
    ...
    runPING(c.get("bams"), c.get("samToFastQ"), c.get("ping"), c.get(CLI.ARG_OUTDIR),
