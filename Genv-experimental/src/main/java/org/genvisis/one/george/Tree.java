...
public class Tree {
	...
	private Tuple<Integer[], Boolean> getArrayHelp(int leafId, Node n, Integer[] storeArr) 
		...
		throw new Exception("leaf id not in tree");
	}
	public Integer[] getArray(int leafId, int maxLeafId) throws Exception {
		Integer[] storeArr = new Integer[maxLeafId]; // leaf ids from 1 - maxLeafId
