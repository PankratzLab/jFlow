...
import org.pankratzlab.gwas.IndependentSNPs;
...
import org.pankratzlab.gwas.SummarizePhenotype;
...
import org.pankratzlab.shared.bioinformatics.FilterSNPsByRegion;
import org.pankratzlab.shared.bioinformatics.MapGenesToSNPs;
import org.pankratzlab.shared.bioinformatics.MapSNPsAndGenes;
import org.pankratzlab.shared.bioinformatics.SuperNovo;
import org.pankratzlab.shared.db.CreateMarkerDatabase;
import org.pankratzlab.shared.db.DBGAPMerge;
import org.pankratzlab.shared.db.DummyDataset;
import org.pankratzlab.shared.db.DumpSAS;
import org.pankratzlab.shared.db.FilterDB;
import org.pankratzlab.shared.db.DBGAPMerge.DBGapExtract;
import org.pankratzlab.shared.db.DBGAPMerge.DBGapLookup;
import org.pankratzlab.shared.gwas.Conditional;
import org.pankratzlab.shared.gwas.GeneScorePipeline;
  ...
  public static void run(String filename, Logger log) throws Elision {
    ...
    try {
      ...
      if (temp == null || temp.equals("")) {
        ...
        org.pankratzlab.utils.widgets.peakAt.fromParameters(filename, log);
      } else if (temp.equalsIgnoreCase("grep")) {
        org.pankratzlab.utils.widgets.grep.fromParameters(filename, log);
